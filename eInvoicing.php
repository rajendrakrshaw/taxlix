...
<head>
	<meta charset="UTF-8" />
	<title>
		Best GST e-Invoicing Software for Business| Generate e-Invoices with Tally, SAP & any other ERP 
	</title>
	...
	<meta name="description" content="ClearTax e-Invoicing software is fast, dependable and affordable solution for all your e-Invoicing needs. With us, switching to the GST e-Invoicing regime is simple, easily integrate with Tally, SAP & other ERPs no matter what your scale is." />
	...
	<meta name="twitter:title" content="Best GST e-Invoicing Software for Business| Generate e-Invoices with Tally, SAP & any other ERP " />
	<meta name="twitter:description" content="ClearTax e-Invoicing software is fast, dependable and affordable solution for all your e-Invoicing needs. With us, switching to the GST e-Invoicing regime is simple, easily integrate with Tally, SAP & other ERPs no matter what your scale is." />
	...
	<!-- For Canonical Link Addition -->
		...
		<link rel="canonical" href="https://cleartax.in/s/e-invoicing-enterprise-software">
...
<script defer>
    ...
    for(var i=0; i < config.length ; i++){
        ...
        gtag('config', config[i], { 
            'groups': groups[i], 
            'content_group': 'v2_e-invoicing-enterprise-software',
        });
    }
    ...
    gtag('event', 'pageview', {
        ...
        'parent_category': 'v2',
        'sub_category': 'e-invoicing-enterprise-software',
    ...
    "navbar": {
      ...
      "right": {
        ...
        "item_4": {
          ...
          "designType": "blue_btn",
          "new_tab": true,
          "url": "https://cleartax.in/s/contact-sales?pageCategoryType=einvoice&ref=/s/e-invoicing-enterprise-software/",
          "hide_for_logged_in_user": true
        },
        "item_5": {
          "label_text": "My Account",
...
<style>
    #EinvoiceLPsocialProofingImageDesktop, #EinvoiceLPsocialProofingImageMobile{
        display: none;
    }
    .slick-disabled {
        opacity: 25%;
    ...
    #einvoice-eligibility,#contact-sales {
		width: 400px;
    }
    .form_height{
        min-height: 450px;
...
<div class="lil-container lil-pt-0 sm:lil-pt-6">
    <!--Section 1-->
    <!--More Money in your pocket-->
    <div
        class="lil-flex lil-items-center hero-section md:lil-pt-6 md:lil-items-center md:lil-flex-col-reverse sm:lil-pt-6 sm:lil-pb-0 sm:lil-flex-col-reverse">
        <div class="lil-w-7/12 md:lil-w-full sm:lil-w-full">
			<p class="lil-font-bold sm:lil-hidden">Clear e-Invoicing</p>
            <h1 class="lil-text-s-56 lg:lil-text-s-48 sm:lil-text-s-28 hero-header dropSize"><span class="lil-inline-block">Smart, Fast & Reliable e-Invoicing Solution </span> </h1>
            <!-- <p class="lil-font-bold lil-pt-2">Get up and running in 3 minutes</p> -->
            <div class="lil-flex lil-pt-4 sm:lil-items-start">
                <div class="lil-tick-wrapper lil-mt-1">
                    <div class="lil-tick"></div>
                </div>
                <p class="lil-px-2 hero-line lil-text-s-18 sm:lil-w-5/6">
                    Fastest IRN generation</p>
            </div>
            <div class="lil-flex lil-pt-4 sm:lil-items-start">
                <div class="lil-tick-wrapper lil-mt-1">
                    <div class="lil-tick"></div>
                ...
                <p class="lil-px-2 hero-line lil-text-s-18 sm:lil-w-5/6">
                    Integrate with Tally (or any other) ERP </p>
            </div>
            <div class="lil-flex lil-pt-4 sm:lil-items-start sm:lil-pt-2">
                <div class="lil-tick-wrapper lil-mt-1">
                    <div class="lil-tick"></div>
                </div>
                <p class="lil-px-2 hero-line lil-text-s-18 sm:lil-w-5/6">99.9% uptime with 6 GSP backup servers </p>
                <!-- <p class="lil-px-2 hero-line xl:lil-hidden lg:lil-hidden md:lil-hidden sm:lil-w-5/6">Uninterrupted with zero downtime</p> -->
            </div>
            <div id="EinvoiceLPsocialProofingImageMobile" >
                <div  class="lg:lil-hidden lil-mt-6 md:lil-hidden xl:lil-hidden">
                    <picture>
                        ...
                        <img class="social-img" alt="Black mobile snapshot" src="https://assets1.cleartax-cdn.com/cleartax/images/1647351506_einvoicinglpmobile.svg">
                    </picture>
                </div>
            </div>
            <div class="lil-pt-6 lil-mt-3 lil-pb-3 sm:lil-w-full sm:lil-hidden">
				<!-- <a class="lil-btn lil-cursor-pointer lil-btn-blue sm:lil-w-full" onclick="handleTrack({label: 'hero_button', isSSO: true, obj: this});createBase64('https://accounts.cleartax.in/v2?product=einvoice');">Try Now</a> -->
				<a id="einvoiceLPRADBtnDesktop" onclick="handleTrack({label: 'hero_button', obj: this});" class="lil-btn lil-cursor-pointer lil-btn-blue sm:lil-w-full" href="https://cleartax.in/s/contact-sales?pageCategoryType=einvoice&ref=/s/e-invoicing-enterprise-software/" target="_blank">
                    Request a demo
                </a>
			</div>
        </div>
        <div class="lil-w-1/2 md:lil-w-full sm:lil-w-full xs:lil-w-full md:lil-my-5 sm:lil-mt-5 sm:lil-my-5">
            <video id="einvoice-video-1"  preload="none" oncontextmenu="return false;" playsinline width="100%" poster="https://assets1.cleartax-cdn.com/cleartax/images/1626429833_image71.webp"  height="auto">
                <source src="https://assets1.cleartax-cdn.com/cleartax/images/1626345377_einvproductvideov3.webm"
                        type="video/webm">
                <source src="https://assets1.cleartax-cdn.com/cleartax/images/1626350847_einvproductvideov31.mp4"  type="video/mp4">
                Your browser does not support HTML video.
            </video> 
            <div id="EinvoiceLPsocialProofingImageDesktop" >
                <div class="sm:lil-hidden lil-pt-10 hideIn-mobile">
                    <div class="animated anim-zoom">
                        <picture>
                            <source type="image/webp" media="(max-width: 990px)" sizes="1x1"
                                srcset="https://assets1.cleartax-cdn.com/cleartax/images/1638429551_1x1.png">
                            <img class="social-img" style="max-width: 700px;width: 450px;margin: auto;" alt="Black mobile snapshot" src="https://assets1.cleartax-cdn.com/cleartax/images/1647318615_socialproofseinvoice.svg">
                        </picture>
                    </div>
...
<div id="tabsSection2Accordians" class="lil-container lil-py-20 xl:lil-hidden lg:lil-hidden">
    
    <div class="accordian lil-w-full lil-border-sm lil-border-grey-300 lil-rounded-lg lil-p-6 lil-mt-6" onclick="accordianToggle(this); handleTrack({label: 'promise_fold_integrations', obj: this});">
        <div class="accordian-header lil-flex lil-justify-between lil-items-center">
            <p class="lil-font-bold lil-text-font-500 lil-text-s-20">Integrations</p>
            <svg
	width="10"
	height="6"
	viewBox="0 0 10 6"
...
>
	<path
		d="M0.83712 5.5028C1.16307 5.82646 1.68939 5.82553 2.0142 5.50072L5.24336 2.27156L8.48054 5.50169C8.80529 5.82573 9.33115 5.82544 9.65554 5.50104C9.98019 5.1764 9.98019 4.65005 9.65554 4.3254L5.83262 0.502481C5.50718 0.177044 4.97954 0.177044 4.65411 0.502481L0.835034 4.32155C0.508602 4.64799 0.509537 5.17752 0.83712 5.5028Z"
		fill="#9092A3"
	></path>
</svg>

        </div>
        <div class="accordian-content lil-hidden">
            <ul class="lil-list-disc lil-text-font-200 lil-text-base lil-font-medium lil-leading-loose lil-pl-3 lil-pt-5">
                
                <li>Inhouse team of 50+ members for high quality integrations</li>
                
                <li>Integration across all ERPs including any custom ERPs</li>
                
                <li>Easy upgrades due to tax law changes</li>
                
            </ul>
        </div>
    </div>
    
    <div class="accordian lil-w-full lil-border-sm lil-border-grey-300 lil-rounded-lg lil-p-6 lil-mt-6" onclick="accordianToggle(this); handleTrack({label: 'promise_fold_support', obj: this});">
        <div class="accordian-header lil-flex lil-justify-between lil-items-center">
            <p class="lil-font-bold lil-text-font-500 lil-text-s-20">360&#176; customer support</p>
            <svg
	width="10"
	height="6"
	viewBox="0 0 10 6"
	...
	></path>
        ...
        <div class="accordian-content lil-hidden">
            <ul class="lil-list-disc lil-text-font-200 lil-text-base lil-font-medium lil-leading-loose lil-pl-3 lil-pt-5">
                ...
                <li>4hrs Resolution SLA and 1 hr Response sla</li>
                
                <li>Strong technical support</li>
                
                <li>Dedicated key account manager</li>
                
                <li>24*7 in-house technical support and advisory services</li>
                
            </ul>
        </div>
    </div>
    
    <div class="accordian lil-w-full lil-border-sm lil-border-grey-300 lil-rounded-lg lil-p-6 lil-mt-6" onclick="accordianToggle(this); handleTrack({label: 'promise_fold_security', obj: this});">
        <div class="accordian-header lil-flex lil-justify-between lil-items-center">
            <p class="lil-font-bold lil-text-font-500 lil-text-s-20">Security</p>
            <svg
	width="10"
	height="6"
	viewBox="0 0 10 6"
...
>
    ...
    <div class="accordian lil-w-full lil-border-sm lil-border-grey-300 lil-rounded-lg lil-p-6 lil-mt-6" onclick="accordianToggle(this); handleTrack({label: 'promise_fold_data-management', obj: this});">
        <div class="accordian-header lil-flex lil-justify-between lil-items-center">
            <p class="lil-font-bold lil-text-font-500 lil-text-s-20">Data Management</p>
            <svg
	width="10"
	height="6"
	viewBox="0 0 10 6"
	...
	></path>
        ...
        <div class="accordian-content lil-hidden">
            <ul class="lil-list-disc lil-text-font-200 lil-text-base lil-font-medium lil-leading-loose lil-pl-3 lil-pt-5">
                ...
                <li>Historical data backup and storage</li>
...
<div id="tabsSectionFold2" class="lil-flex lil-flex-wrap lil-justify-center lil-py-20 sm:lil-hidden md:lil-hidden">
	<div
		class="lil-w-full lil-bg-grey-190 product-segment-tabs lil-sticky lil-flex lil-justify-center lil-border-b-sm lil-border-grey-300">
		<ul id="productSegmentTabs" class="lil-tabs lil-container lil-h-auto lil-overflow-x-hidden">
            
			<li class="lil-tab lil-tab-active lil-w-1/4" style="background-color: #eef3f9;">
				<a class="lil-cursor-pointer" onclick="switchTabTo('integrations', this); handleTrack({label: 'promise_fold', obj: this})">
					<div class="lil-tab-heading-text lil-pt-2 lil-text-s-24 lil-items-center lil-font-semibold lg:lil-text-s-20">
                       Integrations
                    </div>
				</a>
			</li>
            
			<li class="lil-tab  lil-w-1/4" >
				<a class="lil-cursor-pointer" onclick="switchTabTo('support', this); handleTrack({label: 'promise_fold', obj: this})">
					<div class="lil-tab-heading-text lil-pt-2 lil-text-s-24 lil-items-center lil-font-semibold lg:lil-text-s-20">
			...
			<li class="lil-tab  lil-w-1/4" >
				<a class="lil-cursor-pointer" onclick="switchTabTo('security', this); handleTrack({label: 'promise_fold', obj: this})">
					<div class="lil-tab-heading-text lil-pt-2 lil-text-s-24 lil-items-center lil-font-semibold lg:lil-text-s-20">
                       Security
                    </div>
				</a>
			...
			<li class="lil-tab  lil-w-1/4" >
				<a class="lil-cursor-pointer" onclick="switchTabTo('data-management', this); handleTrack({label: 'promise_fold', obj: this})">
					<div class="lil-tab-heading-text lil-pt-2 lil-text-s-24 lil-items-center lil-font-semibold lg:lil-text-s-20">
                       Data Management
                    </div>
				</a>
    ...
    <div class="lil-container">
        ...
        <div class="section2TabContent lil-w-full " id="integrations">
            <div class="lil-flex lil-w-full lil-items-start lil-justify-between lil-h-">
                <div class="lil-w-1/2 lil-pr-10">
                    <p class="lil-font-bold lil-text-font-500 lil-pt-10 lil-text-s-32">Integrations</p>
                    
                    <div class="lil-flex lil-pt-5 lil-items-center">
                        <div class="lil-tick-wrapper lil-mt-1">
                            <div class="lil-tick"></div>
                        </div>
                        <p class="lil-px-2 lil-font-medium lg:lil-text-s-18">
                            Inhouse team of 50+ members for high quality integrations
                        </p>
                    </div>
                    ...
                    <div class="lil-flex lil-pt-5 lil-items-center">
                        ...
                        <p class="lil-px-2 lil-font-medium lg:lil-text-s-18">
                            Integration across all ERPs including any custom ERPs
                        </p>
                    </div>
                    ...
                    <div class="lil-flex lil-pt-5 lil-items-center">
                        ...
                        <p class="lil-px-2 lil-font-medium lg:lil-text-s-18">
                            Easy upgrades due to tax law changes
                        </p>
                    </div>
                    
                </div>
                <img class="lil-w-5/12 lil-mt-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1607400446_connectwithrhs.png" alt="Integrations_image" width="300px">
            </div>
        </div>
        
        <div class="section2TabContent lil-w-full lil-hidden" id="support">
            <div class="lil-flex lil-w-full lil-items-start lil-justify-between lil-h-">
                <div class="lil-w-1/2 lil-pr-10">
                    <p class="lil-font-bold lil-text-font-500 lil-pt-10 lil-text-s-32">360&#176; customer support</p>
                    ...
                    <div class="lil-flex lil-pt-5 lil-items-center">
                        ...
                        <p class="lil-px-2 lil-font-medium lg:lil-text-s-18">
                            4hrs Resolution SLA and 1 hr Response sla
                        </p>
                    </div>
                ...
                <img class="lil-w-5/12 lil-mt-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1607400465_360support_rhs.png" alt="360&#176; customer support_image" width="300px">
            </div>
        </div>
        
        <div class="section2TabContent lil-w-full lil-hidden" id="security">
            <div class="lil-flex lil-w-full lil-items-start lil-justify-between lil-h-">
                <div class="lil-w-1/2 lil-pr-10">
                    <p class="lil-font-bold lil-text-font-500 lil-pt-10 lil-text-s-32">Security</p>
                ...
                <img class="lil-w-5/12 lil-mt-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1654147662_pic1secfold1.png" alt="Security_image" width="300px">
            </div>
        </div>
        
        <div class="section2TabContent lil-w-full lil-hidden" id="data-management">
            <div class="lil-flex lil-w-full lil-items-start lil-justify-between lil-h-">
                <div class="lil-w-1/2 lil-pr-10">
                    <p class="lil-font-bold lil-text-font-500 lil-pt-10 lil-text-s-32">Data Management</p>
                ...
                <img class="lil-w-5/12 lil-mt-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1609958051_importdata_3_api.png" alt="Data Management_image" width="300px">
            </div>
        </div>
...
<div class="lil-container">
	<!--Loved by 5m tax payers-->
	<section class="lil-mb-6 lil-pt-20 lil-mt-4 sm:lil-pt-10">
        <h2 class="lil-text-center">Over <span class="lil-text-blue-350">3000</span><span class="lil-text-green-350">+</span> businesses onboarded</h2>
        
        <div class="lil-my-12 lil-flex lil-justify-center">
            <div class="lil-w-1/2 sm:lil-w-full">
			    <video class="lil-shadow-xl lil-rounded-xl" width="100%" height="auto" autoplay muted loop>
				    <source src="https://assets1.cleartax-cdn.com/cleartax/images/1615819452_einvvideolanderd5comp1.mp4" type="video/mp4">
				    Your browser does not support HTML video.
			    </video>
            </div>
        </div>
		<div class="lil-mt-24 lil-flex lil-justify-around sm:lil-mt-10 sm:lil-flex-wrap sm:lil-items-center">
			<div class="sm:lil-w-1/2 xl:lil-hidden lg:lil-hidden md:lil-hidden sm:lil-text-center">
				<h3>9K<span class="lil-text-green-250">+</span></h3>
				<p class="lil-text-font-500 sm:lil-pt-2">unique GSTINs</p>
            </div>
            <div class="sm:lil-w-1/2 sm:lil-text-center">
				<h3>24K<span class="lil-text-green-250">+</span></h3>
				<p class="lil-text-font-500 sm:lil-pt-2">unique users </p>
			</div>
			<div class="sm:lil-text-center sm:lil-py-6">
				<h3>30M<span class="lil-text-green-250">+</span></h3>
				<p class="lil-text-font-500 sm:lil-pt-2">IRNs generated</p>
            </div>
            <div class="sm:lil-w-1/2 sm:lil-hidden">
				<h3>9K<span class="lil-text-green-250">+</span></h3>
				<p class="lil-text-font-500 sm:lil-pt-2">unique GSTINs</p>
            </div>
		</div>
    ...
    <!--Section 2-->
    <div class="lil-pt-20 sm:lil-pt-10">
        <h2 class="lil-pb-6">Smart and Simple</h2>
        <p class="lil-w-1/2 lil-pb-6 sm:lil-w-5/6">
            Here’s what makes our unified e-Invoicing-e-waybill solution the most reliable and the smartest option in the market: 
        </p>
        
        <div id="invoiceSlick" class="lil-flex lil-flex-wrap sm:lil-overflow-auto">
            
            <div class="lil-w-1/3 lil-py-6 lil-outline-none sm:lil-w-full">
                
                <div class="lil-promise-horizontal lil-rounded-xl lil-shadow-xl lil-my-6 lil-mx-4 lil-p-5 lil-py-auto sm:lil-shadow-lg sm:lil-mx-3 sm:lil-my-3">
                    <div class="lil-promise-icon-wrapper">
                        <img class="lil-h-10" height="40" src="https://assets1.cleartax-cdn.com/cleartax/images/1607403356_speed.png" alt="Fast"/>
                    </div>
                    <div class="lil-pt-5">
                        <p class="lil-text-s-24 lil-text-font-500 lil-font-bold lil-pb-6 md:lil-h-20 sm:lil-text-s-20 sm:lil-pb-1">
                            Fast</p>
                        <p class="lil-w-full xl:lil-h-20 lg:lil-h-20 md:lil-h-32">Less than 200 ms response time vis-a-vis 3-second market average</p>
                    </div>
                </div>
                
                <div class="lil-promise-horizontal lil-rounded-xl lil-shadow-xl lil-my-6 lil-mx-4 lil-p-5 lil-py-auto sm:lil-shadow-lg sm:lil-mx-3 sm:lil-my-3">
                    <div class="lil-promise-icon-wrapper">
                        <img class="lil-h-10" height="40" src="https://assets1.cleartax-cdn.com/cleartax/images/1607403955_easytomanage.svg" alt="24*7 support"/>
                    </div>
                    <div class="lil-pt-5">
                        <p class="lil-text-s-24 lil-text-font-500 lil-font-bold lil-pb-6 md:lil-h-20 sm:lil-text-s-20 sm:lil-pb-1">
                            24*7 support</p>
                        <p class="lil-w-full xl:lil-h-20 lg:lil-h-20 md:lil-h-32">Around the clock assistance from engineers, 4 hr resolution SLA</p>
                    </div>
                </div>
            ...
            <div class="lil-w-1/3 lil-py-6 lil-outline-none sm:lil-w-full">
                ...
                <div class="lil-promise-horizontal lil-rounded-xl lil-shadow-xl lil-my-6 lil-mx-4 lil-p-5 lil-py-auto sm:lil-shadow-lg sm:lil-mx-3 sm:lil-my-3">
                    <div class="lil-promise-icon-wrapper">
                        <img class="lil-h-10" height="40" src="https://assets1.cleartax-cdn.com/cleartax/images/1607403670_scale.svg" alt="Reliable "/>
                    </div>
                    <div class="lil-pt-5">
                        <p class="lil-text-s-24 lil-text-font-500 lil-font-bold lil-pb-6 md:lil-h-20 sm:lil-text-s-20 sm:lil-pb-1">
                            Reliable </p>
                        <p class="lil-w-full xl:lil-h-20 lg:lil-h-20 md:lil-h-32">99.9% uptime with 6 GSP backup servers i.e, generate e-Invoices anytime at any scale</p>
                    </div>
                </div>
                
                <div class="lil-promise-horizontal lil-rounded-xl lil-shadow-xl lil-my-6 lil-mx-4 lil-p-5 lil-py-auto sm:lil-shadow-lg sm:lil-mx-3 sm:lil-my-3">
                    <div class="lil-promise-icon-wrapper">
                        <img class="lil-h-10" height="40" src="https://assets1.cleartax-cdn.com/cleartax/images/1607403964_security1.png" alt="Secure"/>
                    </div>
                    <div class="lil-pt-5">
                        <p class="lil-text-s-24 lil-text-font-500 lil-font-bold lil-pb-6 md:lil-h-20 sm:lil-text-s-20 sm:lil-pb-1">
                            Secure</p>
                        <p class="lil-w-full xl:lil-h-20 lg:lil-h-20 md:lil-h-32">BThe most secure GSP with high-grade encryption; and 8 years of data backup</p>
                    </div>
                </div>
            ...
            <div class="lil-w-1/3 lil-py-6 lil-outline-none sm:lil-w-full">
                ...
                <div class="lil-promise-horizontal lil-rounded-xl lil-shadow-xl lil-my-6 lil-mx-4 lil-p-5 lil-py-auto sm:lil-shadow-lg sm:lil-mx-3 sm:lil-my-3">
                    <div class="lil-promise-icon-wrapper">
                        <img class="lil-h-10" height="40" src="https://assets1.cleartax-cdn.com/cleartax/images/1607403563_connect.svg" alt="Smart"/>
                    </div>
                    <div class="lil-pt-5">
                        <p class="lil-text-s-24 lil-text-font-500 lil-font-bold lil-pb-6 md:lil-h-20 sm:lil-text-s-20 sm:lil-pb-1">
                            Smart</p>
                        <p class="lil-w-full xl:lil-h-20 lg:lil-h-20 md:lil-h-32">200+ validations for detecting errors and smart user interface for onscreen corrections</p>
                    </div>
                </div>
                
                <div class="lil-promise-horizontal lil-rounded-xl lil-shadow-xl lil-my-6 lil-mx-4 lil-p-5 lil-py-auto sm:lil-shadow-lg sm:lil-mx-3 sm:lil-my-3">
                    <div class="lil-promise-icon-wrapper">
                        <img class="lil-h-10" height="40" src="https://assets1.cleartax-cdn.com/cleartax/images/1606385703_supereasy.svg" alt="A lot more"/>
                    </div>
                    <div class="lil-pt-5">
                        <p class="lil-text-s-24 lil-text-font-500 lil-font-bold lil-pb-6 md:lil-h-20 sm:lil-text-s-20 sm:lil-pb-1">
                            A lot more</p>
                        <p class="lil-w-full xl:lil-h-20 lg:lil-h-20 md:lil-h-32">MIS dashboard for insightful reports 50+ custom print templates Alerts and notifications</p>
                    </div>
                </div>
    ...
    <div class="lil-pt-40 sm:lil-pt-20">
        <div class="lil-w-full lil-flex lil-items-center lil-justify-center lil-flex-wrap lil-text-center sm:lil-text-left sm:lil-flex-col sm:lil-w-full">
            <h2 class="lil-py-6 lil-text-center sm:lil-text-left"><span class="lil-text-blue-350">100%</span> business continuity</h2>
            <div class="lil-flex lil-justify-center lil-py-6 sm:lil-py-0">
                <p class="lil-w-4/6 lil-text-center sm:lil-w-full sm:lil-text-left"> How to be e-Invoicing ready? First, check the internal system’s readiness with ERP integrations. Second, integrate with a high-fidelity solution to handle critical use-cases. Switch to ClearTax, operating model with 99.99% uptime.
                </p>
            </div>
        </div>
        <img class="lil-pt-20 sm:lil-pt-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1619156257_einvoicingmodule0211.png" alt="einvoicing workflow">
    </div>
    <!--Section 3-->
    <div class="lil-pt-40 lil-pb-5 sm:lil-pt-20">
        <div class="lil-w-full lil-flex lil-justify-center sm:lil-flex-col">
            <div class="lil-w-1/2 lil-items-center lil-flex sm:lil-w-full">
                <div class="lil-w-full">
                    <h2 class="lil-py-6">Connect with any
                        ERP, <span class="lil-text-blue-350">hassle-free</span>
                    </h2>
                    <p class="lil-pb-4 sm:lil-w-5/6">No matter what platform you use, we connect with it. We are compatible with most ERPs and ingest data error-free.</p>
                    
                </div>
            </div>
            <div class="lil-w-7/12 lil-flex lil-items-center lil-justify-start sm:lil-w-full">
                <img alt="connect with" src="https://assets1.cleartax-cdn.com/cleartax/images/1607400446_connectwithrhs.png">
            </div>
        </div>
    </div>
    ...
    <div class="lil-pt-40 lil-pb-5 sm:lil-pt-20">
        <div class="lil-w-full lil-flex lil-justify-center lil-flex-wrap sm:lil-flex-col">
            <div class="lil-items-center lil-w-1/2 lil-flex sm:lil-w-full">
                <div class="lil-w-full">
                    <h2 class="lil-py-6">Integrate easily with
                        <span class="lil-text-blue-350">GST</span> and <span class="lil-text-blue-350 lil-inline-block">e-Way bills</span>
                    </h2>
                    <p class="lil-pb-4 lil-w-4/5 lil-pt-0">One-click reconciliation with e-Way bills and e-Invoice register in GSTR1 without repeat ingestion or integrations.</p>
                    
                </div>
            </div>
            <div class="lil-flex lil-items-center lil-w-1/2 lil-justify-start sm:lil-w-full sm:lil-pt-4">
                <img alt="integrate easily" src="https://assets1.cleartax-cdn.com/cleartax/images/1607401376_integrateesily_rhs.png">
            </div>
        </div>
    </div>
    ...
    <div class="lil-pt-40 sm:lil-pt-20">
        <div class="lil-w-full lil-flex lil-justify-center lil-flex-wrap sm:lil-flex-col-reverse">
            <div class="lil-items-center lil-flex sm:lil-w-full">
                <div class="lil-text-center sm:lil-text-left sm:lil-w-full">
                    <h2 class="lil-py-6 lil-text-center sm:lil-text-left">Assured peace of mind </h2>
                    <div class="lil-flex lil-justify-center lil-py-6 sm:lil-py-0">
                        <p class="lil-w-4/6 lil-text-center sm:lil-w-full sm:lil-text-left">We offer a highly user-friendly platform with all the functionalities needed for your growth. Robust new feature pipeline to keep you future ready.</p>
                    </div>
        ...
        <div id="section7TabEInvoicing" class="lil-flex lil-pt-10 sm:lil-overflow-auto">
	...
	<ul class="lil-vertical-tabs lil-w-full">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1607404825_manageinwardinvoice.svg" alt="Create, print, cancel, manage" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Create, print, cancel, manage</div>
					</div>
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1607404839_notify.svg" alt="One-click communication" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">One-click communication</div>
					</div>
					<div class="lil-vertical-tab-writeup">
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606718545_createcustom.svg" alt="Configure custom templates" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Configure custom templates</div>
					</div>
					<div class="lil-vertical-tab-writeup">
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1607405108_relibilty.svg" alt="Always on, 99.99% uptime" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Always on, 99.99% uptime</div>
					</div>
					<div class="lil-vertical-tab-writeup">
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1607405098_scale1.svg" alt="No scale too steep" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">No scale too steep</div>
					</div>
					<div class="lil-vertical-tab-writeup">
...
<div id="section7eInvoicingSlick" class="lil-w-6/12 lil-pl-8 lil-items-center lil-flex lil-justify-center sm:lil-w-full sm:lil-pl-0">
	
	
	<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-md lil-pb-6">
		
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1607404825_manageinwardinvoice.svg" alt="Create, print, cancel, manage" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Create, print, cancel, manage</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Perform all operations on e-Invoices through a single user friendly console.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1607344290_richexhaustive_01_rhs.png" alt="Create, print, cancel, manage" />
			
		</div>
		
	
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-md lil-hidden lil-pb-6">
			
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1607404839_notify.svg" alt="One-click communication" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">One-click communication</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Send an email to all your customers on a single click through an inbox option for purchase e-Invoices.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1607344304_richexhaustive_02_rhs.png" alt="One-click communication" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-md lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606718545_createcustom.svg" alt="Configure custom templates" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Configure custom templates</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Reflect your brand and preferences by selecting templates for print and communication.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1607344321_richexhaustive_03_rhs.png" alt="Configure custom templates" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-md lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1607405108_relibilty.svg" alt="Always on, 99.99% uptime" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Always on, 99.99% uptime</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">With zero downtime and multiple GSP redundancies in place, we are up and running 24x7.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1607344446_richexhaustive_04_rhs.png" alt="Always on, 99.99% uptime" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-md lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1607405098_scale1.svg" alt="No scale too steep" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">No scale too steep</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Scale at will as you migrate to e-Invoicing for B2B and B2C customers.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1607344456_richexhaustive_05_rhs.png" alt="No scale too steep" />
    ...
    <div class="lil-pt-40 sm:lil-pt-20">
        <h2 class="lil-text-center sm:lil-text-left">
            <span class="lil-text-blue-350">24/7 </span> customer support
        </h2>
        <div class="lil-flex lil-justify-center lil-py-6">
            <p class="lil-w-7/12 lil-text-center sm:lil-w-full sm:lil-text-left">Round the clock on-call engineers and 100+ CA’s to resolve any issue whenever you need it.</p>
        </div>
        <div class="lil-flex lil-items-center lil-relative lil-justify-center lil-pt-16 sm:lil-pt-0">
            <img class="lil-w-4/6 sm:lil-w-full" src="https://assets1.cleartax-cdn.com/cleartax/images/1607400465_360support_rhs.png"
                alt="text message screenshot">
        </div>
    </div>
    ...
    <div class="lil-pt-40 sm:lil-pt-20">
        <div class="lil-flex lil-justify-between lil-items-start sm:lil-flex-col">
            <div class="lil-w-7/12 lil-pr-8 md:lil-pr-0 sm:lil-w-full sm:lil-pr-0">
                <h2 class="lil-my-2">
                    Your data security<br class="lg:lil-hidden md:lil-hidden sm:lil-hidden"/> is our priority
                </h2>
                <p class="lil-pt-4 lil-text-left sm:lil-w-full">
            ...
            <div class="lil-flex lil-justify-end lil-items-start lil-w-5/12 sm:lil-hidden">
                <!--Safari fix - added inline h/w height kept at auto for fixing aspect ratio-->
                <img style = "width:100%; height:auto;" alt="security logo" src="https://assets1.cleartax-cdn.com/cleartax/images/1607401516_yourdataisourpriority_rhs.png">
            </div>
        </div>
        <div class="lil-flex lil-flex-wrap lil-py-32 lil-justify-between md:lil-py-12 sm:lil-py-0 sm:lil-flex-col">
            
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal sm:lil-pr-8">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12 sm:lil-h-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1606110290_encryption.svg" alt="SSL encryption"/>
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
						<h6 class="sm:lil-text-s-24">SSL encryption</h6>
						<p class="lil-mt-5 lil-pr-4 sm:lil-mt-4 sm:lil-w-full">
			...
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal sm:lil-pr-8">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12 sm:lil-h-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1606110503_home_data_storage.svg" alt="ISO 27001 data storage"/>
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
						...
						<p class="lil-mt-5 lil-pr-4 sm:lil-mt-4 sm:lil-w-full">
                            ...
                            <a class="lil-underline" target="_blank" href="https://assets1.cleartax-cdn.com/s/img/2020/08/07140355/IN83119E-DEFMACRO-SOFTWARE-PV...pdf">View</a>
			...
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal sm:lil-pr-8">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12 sm:lil-h-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1606817014_certificate.svg" alt="SOC 2 certified"/>
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
						...
						<p class="lil-mt-5 lil-pr-4 sm:lil-mt-4 sm:lil-w-full">
                            ...
                            <a class="lil-underline" target="_blank" href="https://assets1.cleartax-cdn.com/s/img/2020/08/14122813/ClearTax-SOC-2-Type-1-Summary-Report.pdf">View</a>
			...
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal sm:lil-pr-8">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12 sm:lil-h-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1606817871_fullaudittrails.svg" alt="Branch-level controls"/>
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
			...
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal sm:lil-pr-8">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12 sm:lil-h-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1606817933_certificate.svg" alt="2-factor authentication"/>
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
			...
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal sm:lil-pr-8">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12 sm:lil-h-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1606818015_authentication.svg" alt="User access management"/>
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
			...
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal sm:lil-pr-8">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12 sm:lil-h-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1606817428_dataarchival.svg" alt="Data archival, retrieval"/>
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
			...
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal sm:lil-pr-8">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12 sm:lil-h-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1606817383_fullaudittrails1.svg" alt="Full audit trails"/>
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
			...
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal sm:lil-pr-8">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12 sm:lil-h-10" src="https://assets1.cleartax-cdn.com/cleartax/images/1606817547_ipwhitelist.svg" alt="IP-whitelisting"/>
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
        ...
        <!--Section 15-->
    <div class="lil-pt-10 sm:lil-pt-20">
        <div class="lil-flex md:lil-flex-wrap sm:lil-flex-wrap">
            <div class="lil-w-full lil-pr-16 md:lil-w-full sm:lil-w-full sm:lil-px-0">
                <h2>
                    Get a demo.
Let’s talk.
                </h2>
                ...
                <div class="lil-w-full lil-flex lil-justify-start lil-pt-6">

                    <a onclick="handleTrack({label: 'hero_button', obj: this});" class="lil-pt-6" href="./contactSales.php" target="_blank">
                        <button class="lil-btn lil-btn-blue lil-text-s-20 lil-cursor-pointer sm:lil-text-base sm:lil-mt-0 sm:lil-items-center">Request a demo</button>
                    </a>
...
<div class="lil-modal lil-rounded-xl" id="einvoice-eligibility">
	<span id="closeEligibilityForm" class="lil-modal-close lil-cursor-pointer lil-text-font-500 lil-text-s-18" onClick="closeModal(document.getElementById('einvoice-eligibility'))">&#10005;</span>
	<div class="lil-px-10 lil-py-10 sm:lil-px-6">
		<div>
    <div class="lil-text-center">
        <div class="lil-text-s-18 lil-text-font-500 lil-font-bold">e-Invoice eligibility check</div>
    </div>
    <div class="lil-pt-2" id="step_1">
        <form>
            <p class="lil-text-s-14 lil-pb-5">Enter your GSTIN to check e-Invoicing eligibility</p>
            <label class="lil-text-s-14 lil-text-font-500">Enter GSTIN</label>
            <input id="gstin_id" type="text"
                class="lil-w-full lil-input lil-border-sm lil-border-grey-300 lil-mt-1 lil-rounded-xl lil-p-2 lil-mb-4"
                required />

            <label class="lil-text-s-14 lil-text-font-500">Email</label>
            <input id="email_id" type="email"
                class="lil-w-full lil-input lil-border-sm lil-border-grey-300 lil-mt-1 lil-rounded-xl lil-p-2 lil-mb-4"
                required />

            <label class="lil-text-s-14 lil-text-font-500">Phone Number</label>
            <input id="phone_number" type="number"
                class="lil-w-full lil-input lil-border-sm lil-border-grey-300 lil-mt-1 lil-rounded-xl lil-p-2 lil-mb-6"
                pattern="[0-9]{10}" max="9999999999" required />

            <button type="submit" class="lil-btn lil-btn-blue lil-w-full" id="btn_step_1">Next</button>
        </form>

    </div>

    <div class="lil-hidden" id="step_2">
        <img class="lil-w-full lil-py-6" alt="captcha_image" id="captcha_img" />

        <label class="lil-text-s-14 lil-text-font-500">Captcha Text</label>
        <input id="CaptchaCode"
            class="lil-w-full lil-input lil-border-sm lil-border-grey-300 lil-mt-1 lil-rounded-xl lil-p-2 lil-mb-6"
            required />

        <button type="button" class="lil-btn lil-btn-blue lil-w-full lil-mt-4" id="btn_step_2" disabled>Next</button>

        <label class="lil-w-full lil-text-base lil-text-font-500 lil-text-center sm:lil-text-s-12"
            id="fail_reason"></label>
    </div>

    <div class="lil-hidden" id="step_3">
        <p class="lil-text-font-500 lil-font-bold lil-text-s-18 lil-w-full lil-text-center lil-pt-4 sm:lil-text-s-14"
            id='eligibilityText'>
        </p>
        <div class="lil-pt-6">
            <table class="lil-border-separate lil-w-full lil-border-spacing-0 lil-table-round" id="results_view">
                <tr>
                    <th class="lil-border-sm lil-w-1/3 lil-bg-grey-100 lil-border-grey-300 lil-p-3 sm:lil-p-2">
                        <p class="lil-font-bold lil-text-left lil-text-base lil-text-font-500 sm:lil-text-s-12">Company
                            Name</p>
                    </th>
                    <th
                        class="lil-border-b-sm lil-border-t-sm lil-border-r-sm lil-border-grey-300 lil-bg-white lil-p-3 sm:lil-p-2">
                        <p class="lil-text-font-500 lil-text-s-14 lil-text-left sm:lil-text-s-10" id="trade_name"></p>
                    </th>
                </tr>
                <tr>
                    <td
                        class="lil-border-r-sm lil-border-l-sm lil-border-b-sm lil-bg-grey-100 lil-border-grey-300 lil-p-3 sm:lil-p-2">
                        <p class="lil-font-bold lil-text-left lil-text-base lil-text-font-500 sm:lil-text-s-12">GSTIN
                        </p>
                    </td>
                    <td class="lil-border-r-sm lil-border-b-sm lil-border-grey-300 lil-bg-white lil-p-3 sm:lil-p-2">
                        <p id="gstin" class="lil-text-font-500 lil-text-left lil-text-s-14 sm:lil-text-s-10"></p>
                    </td>
                </tr>
                ...
                <tr>
                    <td
                        class="lil-border-r-sm lil-border-l-sm lil-border-b-sm lil-bg-grey-100 lil-border-grey-300 lil-p-3 sm:lil-p-2">
                        <p class="lil-font-bold lil-text-left lil-text-base lil-text-font-500 sm:lil-text-s-12">Trader
                            Type</p>
                    </td>
                    <td class="lil-border-r-sm lil-border-b-sm lil-border-grey-300 lil-bg-white lil-p-3 sm:lil-p-2">
                        <p id="trade_type" class="lil-text-font-500 lil-text-left lil-text-s-14 sm:lil-text-s-10"></p>
                    </td>
                </tr>
                <tr>
                    <td
                        class="lil-border-r-sm lil-border-l-sm lil-border-b-sm lil-bg-grey-100 lil-border-grey-300 lil-p-3 sm:lil-p-2">
                        <p class="lil-font-bold lil-text-left lil-text-base lil-text-font-500 sm:lil-text-s-12">
                            e-Invoice Status</p>
                    </td>
                    <td class="lil-border-r-sm lil-border-b-sm lil-border-grey-300 lil-bg-white lil-p-3 sm:lil-p-2">
                        <p id="e-status" class="lil-text-font-500 lil-text-left lil-text-s-14 sm:lil-text-s-10"></p>
                    </td>
                </tr>
            </table>
        </div>
        <button type="button" class="lil-btn lil-btn-blue lil-w-full lil-mt-8"
         onClick="closeModal(document.getElementById('einvoice-eligibility'))" id="closeFormText">Explore our e-Invoicing software</button>
    </div>
</div>
...
<!-- Contact sales Modal -->
<div class="lil-modal lil-rounded-xl lil-w-1/3  lg:lil-w-2/5 md:lil-w-1/2 sm:lil-w-11/12" id="contact-sales">
	<span class="lil-modal-close lil-cursor-pointer lil-text-font-500 lil-text-s-18" onClick="closeModal(document.getElementById('contact-sales'))">&#10005;</span>
...
<div id="contact-sales-modal-wrapper">
	...
	<form class="lil-mt-4 contact-sales-form lil-flex lil-flex-wrap" data-identifier="contact-sales-modal" data-location="" data-category="e-invoicing-enterprise-software">
		...
		<div class="lil-w-full">
			<p class="lil-text-red lil-text-s-10 lil-mb-4"></p>
			<input type="checkbox" tabindex="0" id="contact-sales-modal-waconsent" />
			<label class="lil-text-s-14 lil-text-font-500" for="contact-sales-modal-waconsent">
...
var getFormInstance = (formEleArr)=>new formGroup(formEleArr)
		...
		let errorObj;
		if('e-invoicing-enterprise-software' == 'tally' || 'e-invoicing-enterprise-software' == 'e-invoicing-enterprise-software'){
      ...
      const downloadWhitepaperLabel = "fold_end_to_end_solution_Download Whitepaper_button_Download Whitepaper  →"
		...
		function submitForm(formData){
			...
			let url
			if('/s/e-invoicing-enterprise-software/' == "/s/contact-sales-tds-206/"){
			...
			} else if('e-invoicing-enterprise-software' == "maxitc"){
			...
			.then(response => response.json())
  			.then(data => {
				...
				.classList.remove("lil-hidden");
				document.getElementById(`${formId}-wrapper`).classList.add("lil-hidden");
				let category = 'e-invoicing-enterprise-software';
...
<div class="lil-fixed lil-left-0 lil-bottom-0 lil-bg-white lil-w-full lil-py-4 lil-items-center lil-px-2 lil-hidden sm:lil-flex"> 
    <a id="einvoiceLPCallMobile" href="tel:18005728288" class="lil-btn lil-btn-blue small-text sm:lil-w-1/2 sm:lil-mt-0 sm:lil-mr-1">
        Call us
    </a>
    <a id="einvoiceLPRADBtnModal" onclick="handleTrack({label: 'sticky_bottom_button', obj: this});" class="lil-btn lil-btn-blue small-text sm:lil-w-1/2 sm:lil-mt-0 sm:lil-mr-1" href="https://cleartax.in/s/contact-sales?pageCategoryType=einvoice&ref=/s/e-invoicing-enterprise-software/" target="_blank" style="padding-left: 5px;padding-right: 5px;">
        Request a demo
    </a>
</div>
...
<script>
    function gtag_report_conversion(url) {
        ...
        gtag('event', 'conversion', {
            'send_to': 'AW-948914955/dMf0CKPcgN0BEIuWvcQD',
...
<script>
	function loaderScript(scriptUrl,res, rej){
...
<script>
    function loadTallyScripts(){
        loaderScript(
            "https://www.googletagmanager.com/gtag/js?id=AW-948914955",
            () => {ct_internalTracking('e-invoicing-enterprise-software', 'Success', 'Google_tag_manager_script_load')},
           () => { ct_internalTracking('e-invoicing-enterprise-software', 'Success', 'Google_tag_manager_script_failed')}
        );
        gtag("js", new Date());
...
<script>
    //  script to handle the eligibility check for e invoicing
$(function () {
  const APP_DATA = {
    visitorId: null,
    token: null,
  ...
  const FEILD_NAME = ["gstin_id", "email_id", "phone_number", "CaptchaCode"];

  document.getElementById("btn_step_1").addEventListener("click", (e) => {
    e.preventDefault();
    let gstin = document.getElementById("gstin_id").value,
      email_value = document.getElementById("email_id").value,
      phone_no = document.getElementById("phone_number").value;
    if (gstin !== "" && email_value !== "" && phone_no.length > 9) {
      $("#btn_step_1").prop("disabled", true);
      $.ajax("https://cleartax.in/f/e-invoice/captcha-image", {
        method: "GET",
        xhrFields: { withCredentials: true },
        crossDomain: true,
        success: function (output, status) {
          let { base64Url, aspCookie } = output.result;
          APP_DATA.token = aspCookie;
          document.getElementById("captcha_img").src =
            "data:image/gif;base64," + base64Url;
          APP_DATA.gstin = gstin;
          APP_DATA.email = email_value;
          APP_DATA.phone_no = phone_no;
          $("#step_1").addClass("lil-hidden");
          $("#step_2").removeClass("lil-hidden");
        },
      });
    }
  });
  $('input[id="CaptchaCode"]').keyup(function () {
    if ($(this).val() != "") {
      $("#btn_step_2").prop("disabled", false);
    }
  });
  var leadIngestion = (companyName) => {
    $.ajax({
      ...
      data: JSON.stringify({
        ...
        leadEmail: APP_DATA.email || "",
        leadPhoneNo: APP_DATA.phone_no || "",
        note: "Lead from e invoice eligibility check page",
        leadSourcePage: "ClearTax",
        customAttributesMap: {},
        leadSourceUrl: "https://cleartax.in/s/e-invoicing-enterprise-software",
        referenceURL: "https://cleartax.in/s/e-invoicing-enterprise-software",
        leadCreationTime: new Date(),
      }),
      ...
      success: (res) => {
        console.log("Lead Ingestion Done");
      },
      failure: (e) => {
        console.log("Lead Ingestion failed");
      },
    });
  };

  //to retrive the data from API call
  document.getElementById("btn_step_2").addEventListener("click", (event) => {
    $("#btn_step_2").prop("disabled", true);
    let { token, gstin } = APP_DATA;
    $.ajax({
      url: "https://cleartax.in/f/e-invoice/status",
      xhrFields: { withCredentials: true },
      data: {
        gstin: gstin,
        hasCaptcha: document.getElementById("CaptchaCode").value,
        "asp-cookie": token,
      },
      ...
      success: function (res) {
        if (res.message !== "failure") {
          ...
          if (res.result["is_enabled"]) {
            document.getElementById("eligibilityText").innerHTML =
              'Your business is <span class="lil-text-blue-350">ELIGIBLE</span> for <br/> e-invoicing!';
          } else {
            document.getElementById("eligibilityText").innerHTML =
              'Your business is <span class="lil-text-blue-350">NOT ELIGIBLE</span> for <br/> e-invoicing yet!';
          }
          $("#step_2").addClass("lil-hidden");
          $("#step_3").removeClass("lil-hidden");
          leadIngestion(res.result["trade_name"]);
        } else {
          document.getElementById("fail_reason").innerHTML =
            res.result.failure_reason;
          $("#btn_step_2").prop("disabled", false);
        }
      },
    });
  ...
  // function to clear all modal data once its been closed
  var clearData = () => {
    for (let key in APP_DATA) APP_DATA[key] = null;
    FEILD_NAME.forEach(
      (vaue) => (document.getElementById(vaue).value = "")
    );
  };

  $("#closeEligibilityForm,#closeFormText").on("click", function () {
    clearData();
    $("#btn_step_1").prop("disabled", false);
    $("#step_1").removeClass("lil-hidden");
    $("#step_2").addClass("lil-hidden");
    $("#step_3").addClass("lil-hidden");
  });
});
    ...
    (function(){
        ...
        const propertiesTabWLine = {
            ...
            duration: 4000
				...
				var section7TabEInvoicing;
				function startTimerForTabs() {
					try {
						if (isElementVisibleOnScreen(document.getElementById('section7TabEInvoicing')) && !section7TabEInvoicing) {
							section7TabEInvoicing = new CustomTab("#section7TabEInvoicing", propertiesTabWLine);
						}
					} catch (e) {}
				}
...
<script>
    ...
    const settingsProductsTypes = {
        infinite: false,
        slidesToShow: 3,
        slidesToScroll: 1,
        nextArrow: "#productTypeCardsRightButton",
        prevArrow: "#productTypeCardsLeftButton",
        responsive: [
        {
            breakpoint: 1400,
            settings: {
    ...
    const settingsReinforcement = {
        infinite: false,
        slidesToShow: 3,
        slidesToScroll: 1,
        nextArrow: "#reinforcementTypeCardsRightButton",
        prevArrow: "#reinforcementTypeCardsLeftButton",
        responsive: [
        {
            breakpoint: 1400,
            settings: {
    ...
    if (window.innerWidth < 768) {
        $("#invoiceSlick").slick(settingsVerticalTab);
        $("#section7eInvoicingSlick").slick(settingsVerticalTab);
        $("#ingestSlick").slick(settingsVerticalTab);
    }
    $("#productTypeCards").slick(settingsProductsTypes);
    $("#reinforcementTypeCards").slick(settingsReinforcement);
...
return new PlayerJs(videoId,options); 
  ...
  <script>
          let img = new Image()
          img.src = document.getElementById("einvoice-video-1").getAttribute('poster');
          img.onload = function(){
              document.getElementById("einvoice-video-1").style.backgroundColor = "white"
          }
          let lastEvent =null
          let video = setUpVideo('einvoice-video-1',{
  ...
  <script>
    function accordianToggle(accordian) {
        accordian.querySelector('.accordian-content').classList.toggle('lil-hidden')
        accordian.querySelector('.accordian-header svg').classList.toggle('rotate-180')
    }
</script>
<script>
...
<script>
	...
	function switchTabTo(tabContentId, currentTab){
        const allTabs = document.querySelectorAll('#productSegmentTabs li');
        allTabs.forEach((tab)=>{
            if (isParent(tab,currentTab)){
                tab.classList.add('lil-tab-active');
                tab.style.backgroundColor = '#eef3f9';
            } else {
                tab.classList.remove('lil-tab-active');
                tab.style.backgroundColor = '#fafafa';
            }
        })

        const allTabContents = document.querySelectorAll('.section2TabContent');
        allTabContents.forEach((tabContent)=>{
            if (tabContent.id === tabContentId) tabContent.classList.remove('lil-hidden')
            else tabContent.classList.add('lil-hidden')
        }) 
	}
...
<script type = "application/ld+json" > {
        ...
        "description": "ClearTax e-Invoicing software is fast, dependable and affordable solution for all your e-Invoicing needs. With us, switching to the GST e-Invoicing regime is simple, easily integrate with Tally, SAP & other ERPs no matter what your scale is.",
        "brand": {
            "@type": "Thing",
            "name": "e-Invoicing Software"
        },
...
const handleTrackGA4 = (action, logObj, trackValueObj) => {
    ...
    if (window.ga) {
        ...
        gtag('set', 'content_group', 'v2_e-invoicing-enterprise-software');
...
<script>
	...
	var categoryName = 'e-invoicing-enterprise-software';
...
<!-- Page scheme -->
	...
	<script type="application/ld+json">
	{
		...
		"mainEntityOfPage": {
			"@type": "WebPage",
			"@id": "https://cleartax.in/s/e-invoicing-enterprise-software"
			
		},
		"headline": "Best GST e-Invoicing Software for Business| Generate e-Invoices with Tally, SAP & any other ERP ",
		"description": "ClearTax e-Invoicing software is fast, dependable and affordable solution for all your e-Invoicing needs. With us, switching to the GST e-Invoicing regime is simple, easily integrate with Tally, SAP & other ERPs no matter what your scale is.",
		"image": {
			"@type": "ImageObject",
    ...
    window.addEventListener('DOMContentLoaded', () => {
       ...
       const hitsBoxId = isSearchMobile?"#hitsMobile":"#hits"
        ...
        searchWrapper[0].addEventListener("mousedown",(e)=>{
           if('/s/e-invoicing-enterprise-software/' == "/landing-pages/search/"){
               e.preventDefault()
