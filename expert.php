...
<head>
	<meta charset="UTF-8" />
	<title>
		Best Software for Tax Experts/Professionals
	</title>
	...
	<meta name="description" content="ClearTax provides an unified software tailored perfectly for Tax Experts. File GST Returns (G1-G9). Income Tax Returns, E-TDS and Claim 100% ITC with AI powered reconciliations. Try For FREE!" />
	...
	<meta name="twitter:title" content="Best Software for Tax Experts/Professionals" />
	<meta name="twitter:description" content="ClearTax provides an unified software tailored perfectly for Tax Experts. File GST Returns (G1-G9). Income Tax Returns, E-TDS and Claim 100% ITC with AI powered reconciliations. Try For FREE!" />
	...
	<meta itemprop="name" content="Best Software for Tax Experts/Professionals" />
	<meta itemprop="description" content="ClearTax provides an unified software tailored perfectly for Tax Experts. File GST Returns (G1-G9). Income Tax Returns, E-TDS and Claim 100% ITC with AI powered reconciliations. Try For FREE!" />
	<meta itemprop="image"
		content="https://assets1.cleartax-cdn.com/social/cleartax-og-image-v5.png" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Best Software for Tax Experts/Professionals" />
	<meta property="og:image"
		content="https://assets1.cleartax-cdn.com/social/cleartax-og-image-v5.png" />
	<meta property="og:image:alt" content="ClearTax provides an unified software tailored perfectly for Tax Experts. File GST Returns (G1-G9). Income Tax Returns, E-TDS and Claim 100% ITC with AI powered reconciliations. Try For FREE!" />
	<meta property="og:description" content="ClearTax provides an unified software tailored perfectly for Tax Experts. File GST Returns (G1-G9). Income Tax Returns, E-TDS and Claim 100% ITC with AI powered reconciliations. Try For FREE!" />
	...
	<!-- For Canonical Link Addition -->
		...
		<link rel="canonical" href="https://cleartax.in/tax-experts">
    ...
    "navbar": {
      ...
      "right": {
        ...
        "item_4": {
          ...
          "designType": "blue_btn",
          "new_tab": true,
          "url": "https://cleartax.in/s/contact-sales?pageCategoryType=einvoice&ref=/s/v2/tax-experts/",
          "hide_for_logged_in_user": true
        },
        "item_5": {
          "label_text": "My Account",
...
<div class="lil-max-w-screen-xl lil-mx-auto guitar lil-pt-20 sm:lil-pt-8">
    <section
        ...
        <div class="lil-w-1/2 md:lil-w-full sm:lil-w-full sm:lil-pt-8">
            <p class="lil-text-s-24 lil-font-bold sm:lil-hidden">For Tax Experts</p>
            <h1 class="lg:lil-text-s-56 hero-header">Max savings for<br/> your clients</h1>
            ...
            <div class="lil-flex lil-pt-4 lil-items-center sm:lil-pt-2">
                ...
                <p class="lil-px-2 lg:lil-text-s-18 sm:lil-w-5/6 hero-line">Designed by experts like you. </p>
            </div>
        ...
        <div class="lil-w-1/2 md:lil-w-full sm:lil-w-full">
            <img src="https://assets1.cleartax-cdn.com/cleartax/images/1604058525_client_list_compliance.png"
                alt="List of compliance statuses" class="lil-block lil-mx-auto xl:lil-hidden lg:lil-hidden md:lil-hidden" />
            <video width="100%" height="auto" autoplay muted loop class="lil-block lil-mx-auto xl:lil-ml-8 sm:lil-hidden">
                <source src="https://assets1.cleartax-cdn.com/cleartax/images/1614922162_cafold1_21.mp4" type="video/mp4">
...
<div class="lil-container">
    <!--Section 2 -->
    <!--Promise Vertical Tabs-->
    <div class="md:lil-mt-32 sm:lil-mt-20">
        ...
        <div id="verticalPromiseTabs" class="lil-flex lil-items-center sm:lil-flex-wrap">
            ...
            <div class="lil-w-3/4 sm:lil-w-full">
                <div id="savingForClients"
                    ...
                    <div class="lil-w-2/3 lil-pl-24 lil-pr-8 md:lil-px-8 sm:lil-px-0 sm:lil-w-full">
                        <h5 class="sm:lil-text-s-24">Maximum tax savings with every filing</h5>
                        <p class="lil-py-6">
                            Our AI powered reconciliation engine and effective reports empower tax experts
                             to deliver hard savings for their clients. With our platform, a ₹25Cr business
                              can save about ₹5L and 2 days per GSTIN, every month.
                        </p>
                        <div class="lil-pt-6 lil-mt-4 lil-flex lil-flex-wrap sm:lil-mt-0 sm:lil-pt-8">
                            <a onclick="handleTrack({label: 'hero_button', obj: this})" class="lil-btn lil-btn-blue sm:lil-w-full sm:lil-mt-0" href="contactSales.php" target="_blank">Request a demo</a>
		                </div>
                    ...
                    <div class="lil-w-1/3 sm:lil-w-full">
                        <img src="https://assets1.cleartax-cdn.com/cleartax/images/1606297042_desktop_image_80000expertstrustus_rhs.png">
                    </div>
                </div>
                ...
                <div id="speedyPractice"
                    ...
                    <div class="lil-w-2/3 lil-pl-24 lil-pr-8 md:lil-px-8 sm:lil-px-0 sm:lil-w-full">
                        <h5 class="sm:lil-text-s-24">Save 2 man-days per month per client</h5>
                        <p class="lil-py-6">
                            Boost your productivity by filing GST, IT and TDS returns on a single platform without 
                            ever leaving it. Process 10s of clients simultaneously. File from any device,
                             anywhere. No setup. No downloads. 
                        </p>
                        <div class="lil-pt-6 lil-mt-4 lil-flex lil-flex-wrap sm:lil-mt-0 sm:lil-pt-8">
                            <a onclick="handleTrack({label: 'hero_button', obj: this})" class="lil-btn lil-btn-blue sm:lil-w-full sm:lil-mt-0" href="contactSales.php" target="_blank">Request a demo</a>
		                </div>
                ...
                <div id="peaceOfMind"
                    class="verticalPromiseTabsContent lil-hidden lil-items-center lil-flex lil-justify-center sm:lil-flex-col-reverse">
                    <div class="lil-w-2/3 lil-pl-24 lil-pr-0 md:lil-px-8 sm:lil-px-0 sm:lil-w-full">
                        <h5 class="sm:lil-text-s-24">100% accurate, zero notices, zero penalities</h5>
                        <p class="lil-py-6">
                            Error-free and comprehensive- our products are designed by our tax experts
                             who continuously update new tax clauses in our products and test every release.
                              Our cloud offering ensures these updates reach you instantaneously.
                        </p>
                        <div class="lil-pt-6 lil-mt-4 lil-flex lil-flex-wrap sm:lil-mt-0 sm:lil-pt-8">
                            <a onclick="handleTrack({label: 'hero_button', obj: this})" class="lil-btn lil-btn-blue sm:lil-w-full sm:lil-mt-0" href="contactSales.php" target="_blank">Request a demo</a>
		                </div>
    ...
    <div class="lil-pt-40 sm:lil-pt-20">
        <div class="lil-flex lil-justify-between lil-items-center sm:lil-flex-col">
            <div class="lil-flex lil-justify-between lil-items-left lil-flex-col">
                <h2 class="lil-flex lil-w-1/2 lil-text-left sm:lil-w-full">
                    Unified GST, ITR and <br class="lg:lil-hidden md:lil-hidden sm:lil-hidden"/> TDS suite for you
                </h2>
                <div class="lil-flex lil-w-full lil-justify-between lil-items-end sm:lil-items-start sm:lil-flex-col">
                    <p class="lil-py-6 lil-w-5/12 sm:lil-w-4/5">
                        Join 80,000 tax experts who save more than ₹800Cr for their
                         clients every month with a unified, multi-user GST, TDS and ITR platform.
                    </p>
                    <div class="lil-flex lil-py-6 lil-justify-end sm:lil-w-full sm:lil-py-0">
                        <div id="productCardsLeftButton" class="lil-btn-round lil-mx-2">
                            &#8592;</div>
                        <div id="productCardsRightButton" class="lil-btn-round lil-mx-2">
                            &#8594;</div>
                    </div>
                </div>
            </div>
        ...
        <!--Product Cards-->
        <div>
            <div id="productCards" class="lil-flex lil-w-full lil-py-10 sm:lil-overflow-auto sm:lil-pb-0">
                
                <div class="lil-product-card">
                    <div class="lil-product-card-header">
                        <h6 class="sm:lil-text-s-20">ClearGST</h6>
                        <img width="40" height="40" src="https://assets1.cleartax-cdn.com/cleartax/images/1606392078_cleargst.svg">
                    </div>
                    <div class="lil-product-card-content lil-w-5/6 lg:lil-w-4/6">
                        Ace your tax practice with GST invoicing creation, invoice matching and comprehensive returns filing from G1 to G9C , 3x faster.
                    </div>
                    <a onclick="handleTrack({label: 'fold_a_unified_suite_button_ClearGST', obj: this});" href="#" class="lil-product-card-footer">
                        <u>Learn More </u><span class="lil-font-medium">&nbsp; &#8594;</span>
                    </a>
                </div>
                
                <div class="lil-product-card">
                    <div class="lil-product-card-header">
                        <h6 class="sm:lil-text-s-20">ClearITR</h6>
                        <img width="40" height="40" src="https://assets1.cleartax-cdn.com/cleartax/images/1604396303_ca_section3_clearitr.png">
                    </div>
                    <div class="lil-product-card-content lil-w-5/6 lg:lil-w-4/6">
                        File ITRs for people and businesses in under 2 minutes covering all types of ITRs and every possible source of income. 
                    </div>
                    <a onclick="handleTrack({label: 'fold_a_unified_suite_button_ClearITR', obj: this});" href="#" class="lil-product-card-footer">
                        <u>Learn More </u><span class="lil-font-medium">&nbsp; &#8594;</span>
                    </a>
                </div>
                ...
                <div class="lil-product-card">
                    <div class="lil-product-card-header">
                        <h6 class="sm:lil-text-s-20">ClearTDS</h6>
                        <img width="40" height="40" src="https://assets1.cleartax-cdn.com/cleartax/images/1604396381_ca_section3_cleartds.png">
                    </div>
                    <div class="lil-product-card-content lil-w-5/6 lg:lil-w-4/6">
                        Easiest e-TDS filing experience. Modify or file new returns, generate FVUs and Form16s with ease. Fetch Form26 with a click.
                    </div>
                    <a onclick="handleTrack({label: 'fold_a_unified_suite_button_ClearTDS', obj: this});" href="#" class="lil-product-card-footer">
                        <u>Learn More </u><span class="lil-font-medium">&nbsp; &#8594;</span>
                    </a>
                </div>
    ...
    <div class="lil-pt-40 sm:lil-pt-20">
        <div class="lil-w-full lil-flex lil-justify-center lil-flex-wrap sm:lil-flex-col-reverse">
            <div class="lil-w-4/6 lil-items-center lil-flex sm:lil-w-full">
                <div class="lil-items-center lil-flex sm:lil-w-full">
                    <div class="lil-w-full">
                        <h2 class="lil-py-6">GST filing experience, <br class="lg:lil-hidden md:lil-hidden sm:lil-hidden"/> made
                            3x faster</h2>
                        <p class="xl:lil-w-4/6  sm:lil-w-4/5">Eliminate filing errors and save your clients' money
                             with our GST platform that is 3x faster and detects 100% input tax 
                             credits with AI powered reconciliations. </p>
                        <div class="lil-flex lil-pt-10 lil-flex-wrap sm:lil-justify-center">
                            
                            <a onclick="handleTrack({label: 'fold_gst_filing_xp_button', obj: this});" href="#" class="lil-btn lil-btn-link lil-items-center md:lil-mt-6 md:lil-w-full sm:lil-w-full sm:lil-mt-5">Learn more<span
                                class="lil-font-medium lil-inline-block">&nbsp; &#8594;</span></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="lil-w-2/6 lil-flex lil-items-center lil-justify-end sm:lil-hidden">
                <img src="https://assets1.cleartax-cdn.com/cleartax/images/1606452073_cleargst.png">
            </div>
        </div>
	...
	<ul class="lil-vertical-tabs lil-w-full">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606454878_g1tog9.svg" alt="From G1 to G9, for all clients" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">From G1 to G9, for all clients</div>
					</div>
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606454895_import.svg" alt="Import effortlessly, even from Tally" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Import effortlessly, even from Tally</div>
					</div>
					<div class="lil-vertical-tab-writeup">
						Choose from over 8 methods, integrate with client’s Tally system, correct errors on the fly.
					</div>
				</div>
				<span class="lil-vertical-tab-arrow">&#8594;</span>
			</a>
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455170_reconcile.svg" alt="Match 6,000 invoices per minute" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Match 6,000 invoices per minute</div>
					</div>
					<div class="lil-vertical-tab-writeup">
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455060_fileandput.svg" alt="Pull entire GSTIN history in seconds" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455078_analyzeinvoice.svg" alt="Analyze tax credits, dues with reports" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Analyze tax credits, dues with reports</div>
					</div>
					<div class="lil-vertical-tab-writeup">
...
<div id="section4GSTSlick" class="lil-w-6/12 lil-pl-8 lil-items-center lil-flex lil-justify-center sm:lil-w-full sm:lil-pl-0">
	...
	<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606454878_g1tog9.svg" alt="From G1 to G9, for all clients" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">From G1 to G9, for all clients</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">File in under 30 seconds with power workflows such as NIL filing and auto-filed 3B and 9 Forms.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1606997771_fromg1tog9.png" alt="From G1 to G9, for all clients" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606454895_import.svg" alt="Import effortlessly, even from Tally" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Import effortlessly, even from Tally</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Choose from over 8 methods, integrate with client’s Tally system, correct errors on the fly.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1606998016_2.png" alt="Import effortlessly, even from Tally" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455170_reconcile.svg" alt="Match 6,000 invoices per minute" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Match 6,000 invoices per minute</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Reconcile thousands of invoice records in seconds and detect and claim 100% ITC</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1606452951_desktop_fold_gstreturnsmade_tabs_reconcile_rhs.png" alt="Match 6,000 invoices per minute" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-hidden lil-pb-6">
			...
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Push returns in seconds and fetch entire filing database for a GSTIN with our powerful multi-month 2A feature</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1604314072_vert_tabs_line_mock.png" alt="Pull entire GSTIN history in seconds" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455078_analyzeinvoice.svg" alt="Analyze tax credits, dues with reports" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Analyze tax credits, dues with reports</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Smart reports such as multi-month 2A, GSTR-3B vs 2A, GSTR-3B vs 1 and more available on tap.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1606997935_5.png" alt="Analyze tax credits, dues with reports" />
    ...
    <div class="lil-pt-40 sm:lil-pt-20">
        <div class="lil-w-full lil-flex lil-justify-center lil-flex-wrap sm:lil-flex-col-reverse">
            <div class="lil-w-3/5 lil-items-center lil-flex sm:lil-w-full">
                <div class="lil-items-center lil-flex sm:lil-w-full">
                    <div class="lil-w-4/5 sm:lil-w-full">
                        <h2 class="lil-py-6">File any ITR, for any<br class="lg:lil-hidden md:lil-hidden sm:lil-hidden"/> type of income
                        </h2>
                        <p class="lil-pb-4">Boost your tax practice with our simple and fast 
                             ITR filing module. All major ITR forms available,
                             drag and drop files and fetch data from government in a click. </p>
                        <div class="lil-flex lil-pt-10 lil-flex-wrap sm:lil-justify-center">
                            
                            <a onclick="handleTrack({label: 'fold_file_any_itr_button', obj: this});" href="#" class="lil-btn lil-btn-link lil-items-center md:lil-mt-6 md:lil-w-full sm:lil-w-full sm:lil-mt-5">Learn more<span
                                class="lil-font-medium lil-inline-block">&nbsp; &#8594;</span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="lil-w-2/5 lil-flex lil-items-center lil-justify-end sm:lil-hidden">
                <img src="https://assets1.cleartax-cdn.com/cleartax/images/1606452096_cleartaxcloud.png">
            </div>
        </div>
        <div id = "section5TabITR" class="lil-flex lil-pt-10">
	...
	<ul class="lil-vertical-tabs lil-w-full">
		...
		<li class="lil-vertical-tab lil-tab-cta lil-vertical-tab-active">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455284_getstarted.svg" alt="Rich client dashboard" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Rich client dashboard</div>
					</div>
					<div class="lil-vertical-tab-writeup">
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455296_oneclick.svg" alt="Get data with one click" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Get data with one click</div>
					</div>
					<div class="lil-vertical-tab-writeup">
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455307_validate.svg" alt="Validate all edge cases" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Validate all edge cases</div>
					</div>
					<div class="lil-vertical-tab-writeup">
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455454_payandfilewithin.svg" alt="Pay taxes from within product" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Pay taxes from within product</div>
					</div>
					<div class="lil-vertical-tab-writeup">
		...
		<li class="lil-vertical-tab lil-tab-cta">
			...
			<a class="lil-vertical-tab-container">
				...
				<div class="lil-vertical-tab-content">
					<div class="lil-w-1/12 sm:lil-w-1/6">
						<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455078_analyzeinvoice.svg" alt="Analyze and mail your clients" class="lazyload" loading="lazy"/>
					</div>
					<div class="lil-w-11/12 lil-pl-2 sm:lil-w-5/6">
						<div class="lil-vertical-tab-heading">Analyze and mail your clients</div>
					</div>
					<div class="lil-vertical-tab-writeup">
...
<div id="section5ITRSlick" class="lil-w-6/12 lil-pl-8 lil-items-center lil-flex lil-justify-center sm:lil-w-full sm:lil-pl-0">
	...
	<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455284_getstarted.svg" alt="Rich client dashboard" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Rich client dashboard</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Add and select clients to work on. Select recommended ITR or choose your own.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1604314072_vert_tabs_line_mock.png" alt="Rich client dashboard" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455296_oneclick.svg" alt="Get data with one click" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Get data with one click</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Get pre-filled data from Form 16s, Form 26AS and Capital Gains reports through easy import options</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1606999130_ca_2.png" alt="Get data with one click" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455307_validate.svg" alt="Validate all edge cases" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Validate all edge cases</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Check all corner cases with smart checks built at every step so that your clients are notice free.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1606453339_taxcloud_validatealledgecases.png" alt="Validate all edge cases" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455454_payandfilewithin.svg" alt="Pay taxes from within product" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Pay taxes from within product</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Pay and file taxes without going anywhere else. No need for client’s XML files.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1606999143_ca_4.png" alt="Pay taxes from within product" />
		...
		<div class="verticalTabsWLineContent lil-w-full lil-outline-none lil-flex lil-items-center lil-justify-center sm:lil-visible sm:lil-flex-col sm:lil-rounded-lg sm:lil-shadow-lg lil-hidden lil-pb-6">
			...
			<div class="lil-items-center lil-flex lil-px-5 xl:lil-hidden lg:lil-hidden md:lil-hidden">
				<img height="32" width="32" src="https://assets1.cleartax-cdn.com/cleartax/images/1606455078_analyzeinvoice.svg" alt="Analyze and mail your clients" class="lazyload" loading="lazy"/>
				<h4 class="lil-px-5">Analyze and mail your clients</h4>
			</div>
			<p class="lil-p-5 lil-w-11/12 xl:lil-hidden lg:lil-hidden md:lil-hidden">Compute e-file reports and acknowledgements, edit and share with your clients.</p>
			
			<img class="lazyload" loading="lazy" src="https://assets1.cleartax-cdn.com/cleartax/images/1606999149_ca_5.png" alt="Analyze and mail your clients" />
    ...
    <div class="lil-pt-40 sm:lil-pt-20">
        <div class="lil-w-full lil-flex lil-justify-center lil-flex-wrap sm:lil-flex-col-reverse">
            <div class="lil-w-3/5 lil-items-center lil-flex sm:lil-w-full">
                <div class="lil-items-center lil-flex sm:lil-w-full">
                    <div class="sm:lil-w-full">
                        <h2 class="lil-py-6">Easiest e-TDS filing, <br class="lg:lil-hidden md:lil-hidden sm:lil-hidden"/>
                            no notices, no penalty.</h2>
                        <p class="lil-w-4/5 lil-pb-4 sm:lil-w-full">Effortlessly generate Form 16s and file TDS returns. 
                            Detect and use unconsumed challans. Effortlessly generate Form 16s
                             and file TDS returns. </p>
                        <div class="lil-flex lil-pt-10 lil-flex-wrap sm:lil-justify-center">
                            
                            <a onclick="handleTrack({label: 'fold_easiest_etds_filing_button', obj: this});" href="#" class="lil-btn lil-btn-link lil-items-center md:lil-mt-6 md:lil-w-full sm:lil-w-full sm:lil-mt-5">Learn more<span
                                class="lil-font-medium lil-inline-block">&nbsp; &#8594;</span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="lil-w-2/5 lil-flex lil-items-center lil-justify-end sm:lil-hidden">
                <img src="https://assets1.cleartax-cdn.com/cleartax/images/1606452085_cleartds.png">
            </div>
        </div>
        <div id = "section6TabTDS" class="lil-flex lil-pt-10">
...
<div id="section6TDSSlick" class="lil-w-6/12 lil-pl-8 lil-items-center lil-flex lil-justify-center sm:lil-w-full sm:lil-pl-0">
        ...
        <div class="lil-flex lil-justify-between">
            <div class="lil-w-1/2 sm:lil-w-full">
                <h4 class="sm:lil-text-s-28">
                    Work from any place, any <br/> time, any device
                </h4>
                <div class="lil-pt-10 xl:lil-hidden lg:lil-hidden md:lil-hidden">
                    <img src="https://assets1.cleartax-cdn.com/cleartax/images/1606453903_image1.png"
                        alt="Screen views of app">
                </div>
                <div class="lil-flex lil-pt-8 lil-w-full">
                    <div class="lil-w-1/6 xl:lil-w-1/12"><img
                            src="https://assets1.cleartax-cdn.com/cleartax/images/1606455715_cloudbasedplatform.svg"
                            height="40" width="40" /></div>
                    <div class="lil-px-6 lil-w-5/6">
                        <p class="lil-text-font-500 lil-font-bold lil-text-base">Cloud based platform</p>
                        <p class="lil-text-base lil-pt-2">From the convenience of home or office, through any device
                            with secure logins.</p>
                    </div>
                </div>
                <div class="lil-flex lil-pt-8 lil-w-full">
                    <div class="lil-w-1/6 xl:lil-w-1/12"><img
                            src="https://assets1.cleartax-cdn.com/cleartax/images/1606455725_switchbwwebdesktop.svg"
                            height="40" width="40" /></div>
                    <div class="lil-px-6 lil-w-5/6">
                        <p class="lil-text-font-500 lil-font-bold lil-text-base">Switch between our web or desktop app
                        </p>
                        <p class="lil-text-base lil-pt-2">Switch between our web or desktop app based on your
                            convenience.</p>
                    </div>
                </div>
                <div class="lil-flex lil-pt-8 sm:lil-w-full">
                    <div class="lil-w-1/6 xl:lil-w-1/12"><img
                            src="https://assets1.cleartax-cdn.com/cleartax/images/1606455737_zerodowntime.svg"
                            height="40" width="40" /></div>
                    <div class="lil-px-6 lil-w-5/6">
                        <p class="lil-text-font-500 lil-font-bold lil-text-base">Get Fast - all shortcuts in one place
                        </p>
                        <p class="lil-text-base lil-pt-2">One-click access to all important filing actions in your desktop app, so that you save time.</p>
                    </div>
                </div>
                
            </div>
            <div class="lil-w-1/2 lil-flex lil-items-center sm:lil-pr-0 sm:lil-hidden">
                <img src="https://assets1.cleartax-cdn.com/cleartax/images/1606453903_image1.png"
        ...
        <div class="lil-flex lil-justify-between">
            <div class="lil-w-1/2 lil-pr-16 lil-flex lil-items-center sm:lil-pr-0 sm:lil-hidden">
                <video width="100%" height="auto" autoplay muted loop class="lil-block lil-mx-auto">
                    <source src="https://assets1.cleartax-cdn.com/cleartax/images/1608283800_singlescreendbs.mp4" type="video/mp4">
                    Your browser does not support HTML video.
                </video>
            </div>
            <div class="lil-w-1/2 sm:lil-w-full">
                <h4 class="sm:lil-text-s-28">
                    A single dashbaord<br/> to manage all clients
                </h4>
                <div class="lil-pt-10 xl:lil-hidden lg:lil-hidden md:lil-hidden">
                    <img src="https://assets1.cleartax-cdn.com/cleartax/images/1604058525_client_list_compliance.png"
                ...
                <div class="lil-flex lil-pt-8 lil-w-full">
                    <div class="lil-w-1/6 xl:lil-w-1/12"><img
                            src="https://assets1.cleartax-cdn.com/cleartax/images/1606455884_easyclientmanagement.svg"
                            height="40" width="40" /></div>
                    <div class="lil-px-6 lil-w-5/6">
                        <p class="lil-text-font-500 lil-font-bold lil-text-base">Easy client management</p>
                        <p class="lil-text-base lil-pt-2">Manage your entire clientele and their compliance statuses
                            together.</p>
                    </div>
                </div>
                <div class="lil-flex lil-pt-8 lil-w-full">
                    <div class="lil-w-1/6 xl:lil-w-1/12"><img
                            src="https://assets1.cleartax-cdn.com/cleartax/images/1606455894_nonotp.svg"
                            height="40" width="40" /></div>
                    <div class="lil-px-6 lil-w-5/6">
                        <p class="lil-text-font-500 lil-font-bold lil-text-base">Non-OTP workflows and encrypted
                            password storage</p>
                        <p class="lil-text-base lil-pt-2">Ensure you can continue working while your clients keep busy.
                        </p>
                    </div>
                </div>
                <div class="lil-flex lil-pt-8 sm:lil-w-full">
                    <div class="lil-w-1/6 xl:lil-w-1/12"><img
                            src="https://assets1.cleartax-cdn.com/cleartax/images/1606455903_builtinwarningsystem.svg"
                            height="40" width="40" /></div>
                    <div class="lil-px-6 lil-w-5/6">
                        <p class="lil-text-font-500 lil-font-bold lil-text-base">Built in early warning systems</p>
                        <p class="lil-text-base lil-pt-2">On GST, ITR, TDS dashboard to prevent deadline misses and
                            notices.</p>
                    </div>
                </div>
    ...
    <!---->
    <div class="lil-pt-40 sm:lil-pt-20">
        <div class="lil-flex lil-justify-between lil-items-center sm:lil-flex-col-reverse">
            <div class="lil-flex lil-justify-center lil-w-1/2 lil-items-center lil-p-4 sm:lil-w-full">
                <img class="xl:lil-hidden lg:lil-hidden md:lil-hidden"src="https://assets1.cleartax-cdn.com/cleartax/images/1602840067_section6_pinchy.png"/>
                <video width="100%" height="auto" autoplay muted loop class="lil-block lil-mx-auto sm:lil-hidden">
					<source src="https://assets1.cleartax-cdn.com/cleartax/images/1608208496_desktop_fold_designedbyexperts_lhs422.mp4" type="video/mp4">
					Your browser does not support HTML video.
				</video>
            </div>
            <div class="lil-flex lil-w-1/2 lil-justify-between lil-items-left lil-flex-col sm:lil-w-full">
                <div class="lil-flex lil-flex-wrap">
                    <h2 class="lil-flex lil-text-left sm:lil-w-full">
                        Designed <br class="md:lil-hidden lg:lil-hidden xl:lil-hidden" />by experts
                    </h2>
                </div>
                <p class="lil-py-6 lil-w-4/5 sm:lil-w-full">
                    <span class="lil-font-bold">80+</span> in-house CAs co-build and test our products. Most of them are active editors on our home-grown
                    newsroom <a class="lil-underline" href="https://news.cleartax.in/">ClearTax Chronicles</a>. <span class="lil-font-bold">80,000+</span> CAs have given us constant feedback which has helped improve
                    our product.
                </p>
            </div>
        </div>
    ...
    <div class="lil-pt-40 sm:lil-pt-20">
        <div class="lil-flex sm:lil-flex-col">
            <div class="lil-w-1/6 sm:lil-pb-6 sm:lil-w-full">
                <img class="sm:lil-h-16"
                    src="https://assets1.cleartax-cdn.com/cleartax/images/1604035702_db_quote_open.png"
                    alt="open quote">
            </div>
            <h2 class="lil-text-center lil-w-4/6 sm:lil-text-left sm:lil-w-full">On an average, our customer support
                <span class="lil-text-blue-350">tickets</span> are <span class="lil-text-blue-350">resolved</span>
                within <span class="lil-text-blue-350">10 minutes</span></h2>
            <div class="lil-w-1/6 lil-flex lil-items-end lil-relative sm:lil-w-full sm:lil-hidden">
                <img class="lil-bottom-0 lil-absolute"
                    src="https://assets1.cleartax-cdn.com/cleartax/images/1604035716_db_quote_close.png"
                    alt="close quote">
            </div>
        </div>
        <div class="lil-flex lil-justify-center lil-py-6">
            <p class="lil-w-4/6 lil-text-center sm:lil-w-full sm:lil-text-left">Product support is one click, call or
                mail away. Our support is always listening to you. Our products are always adapting to your needs.</p>
        </div>
        <div class="lil-flex lil-items-center lil-relative lil-justify-center">
            <img src="https://assets1.cleartax-cdn.com/cleartax/images/1606307497_ca_on_average1.png"
                alt="text message" class="lil-w-4/6 sm:lil-w-full">
        </div>
    </div>
    <!--Section 13 -->
    <!--Security-->
    ...
    <div id="testimonials" class="lil-pt-40 lil-pb-32 sm:lil-pt-20 sm:lil-hidden">
        <h2 class="lil-text-center">What our clients say</h2>
        <div class="lil-flex lil-pt-10">
            <div class="lil-w-1/3 lil-text-center lil-mx-5">
                <div class="lil-flex lil-pb-3 lil-pt-8 lil-items-center lil-justify-center">
                    <img src="https://assets1.cleartax-cdn.com/cleartax/images/1604901545_ca_dquote.png" alt="double qoute">
                </div>
                <p class="lil-py-6">My executives could learn it so quickly and we implemented literally in a couple of days.</p>
                <div class="lil-text-s-20 lil-font-bold lil-text-font-500 lil-py-1">Mr. Anil Chakravarthy</div>
                <div class="lil-text-base lil-text-font-400 lil-py-1">Tax Practitioner</div>
            </div>
            <div class="lil-w-1/3 lil-text-center lil-mx-5">
                <div class="lil-flex lil-pt-8 lil-pb-3 lil-items-center lil-justify-center">
                    <img src="https://assets1.cleartax-cdn.com/cleartax/images/1604901545_ca_dquote.png" alt="double qoute">
                </div>
                <p class="lil-py-6">We file GST returns for more than 250 clients through ClearTax. Without them, it was not possible.</p>
                <div class="lil-text-s-20 lil-font-bold lil-text-font-500 lil-py-1">Vcas & Co </div>
                <div class="lil-text-base lil-text-font-400 lil-py-1">CA firm, Surat</div>
            </div>
            <div class="lil-w-1/3 lil-text-center lil-mx-5">
                <div class="lil-flex lil-pt-8 lil-pb-3 lil-items-center lil-justify-center">
                    <img src="https://assets1.cleartax-cdn.com/cleartax/images/1604901545_ca_dquote.png" alt="double qoute">
                </div>
                <p class="lil-py-6">Best data import-export features, super easy returns filing, top class support team and webinars.</p>
                <div class="lil-text-s-20 lil-font-bold lil-text-font-500 lil-py-1">Ms. Rohini Karmarkar</div>
                <div class="lil-text-base lil-text-font-400 lil-py-1">Tax Practitioner</div>
            </div>
        </div>
    </div>
    <div class="lil-reinforcement lil-flex lil-my-20 lil-justify-between xl:lil-my-20 lg:lil-my-20 sm:lil-mt-0">
        <div class="lil-reinforcement-content-wrapper lil-my-0 lil-pr-0">
            <div class="lil-pb-6 lil-w-1/2 sm:lil-w-full">
                <div class="lil-reinforcement-title">
                    <h3>Ready to boost your tax practice?</h3>
                </div>
                <div class="lil-pt-6">
                    ...
                    <div class="lil-flex lil-py-2 lil-items-center">
                        ...
                        <p class="lil-px-2">Speed up your tax practice by 3x</p>
                    </div>
                    <div class="lil-flex lil-py-2 lil-items-center">
                        <div class="lil-tick-wrapper">
                            <div class="lil-tick"></div>
                        </div>
                        <p class="lil-px-2">Designed by experts like you</p>
                    </div>
                </div>
                
            </div>
            <div class="lil-flex lil-flex-reverse lil-items-start lil-w-1/2 md:lil-hidden sm:lil-hidden">
                <img class="sm:lil-object-scale-down" src="https://assets1.cleartax-cdn.com/cleartax/images/1606307945_ca_leapfrog.png">
            </div>
        </div>
		</div>
</div>
...
<div class="lil-fixed lil-left-0 lil-bottom-0 lil-bg-white lil-w-full lil-py-4 lil-z-40 lil-items-center lil-px-2 lil-hidden sm:lil-flex"> 
    <a class="lil-btn lil-btn-blue small-text lil-w-1/2 lil-mt-0 lil-mr-1" onclick="handleTrack({label: 'fold_reinforcement_button', obj: this});"
    href='https://accounts.cleartax.in/v2?product=gst&return_path=L24vc3NvP3JlZGlyZWN0X3VybD1MMjQ9'>
        Start free trial
    </a>
    <a onclick="handleTrack({label: 'fold_reinforcement_button', obj: this})" class="lil-btn lil-btn-blue sm:lil-w-1/2 small-text sm:lil-mt-0" href="https://cleartax.in/s/contact-sales?pageCategoryType=gst&form=tax-expert&ref=/s/v2/tax-experts/" target="_blank">
        Request a demo
    </a>
</div>
...
<script>
    (function () {
      ...
      new CustomTab("#section4TabGST", propertiesTabWLine);
      new CustomTab("#section5TabITR", propertiesTabWLine);
      new CustomTab("#section6TabTDS", propertiesTabWLine);
    })();
</script>
...
$(document).ready(function () {
  ...
  if (window.innerWidth < 768) {
    ...
    $("#section5ITRSlick").slick(settingsVerticalTab);
    $("#section6TDSSlick").slick(settingsVerticalTab);
  }
...
function submitRequestDemoForm(id) {
  ...
  addLeads(leadsData, email.value, function() {
    ...
    createActivity(485, sourceURL, email.value, function() {
      if( '/s/v2/tax-experts/' == "/s/gst-return-filing-software/"){
...
<!-- Page scheme -->
	...
	<script type="application/ld+json">
	{
		...
		"mainEntityOfPage": {
			"@type": "WebPage",
			"@id": "https://cleartax.in/tax-experts"
			
		},
		"headline": "Best Software for Tax Experts/Professionals",
		"description": "ClearTax provides an unified software tailored perfectly for Tax Experts. File GST Returns (G1-G9). Income Tax Returns, E-TDS and Claim 100% ITC with AI powered reconciliations. Try For FREE!",
		"image": {
			"@type": "ImageObject",
    ...
    window.addEventListener('DOMContentLoaded', () => {
       ...
       const hitsBoxId = isSearchMobile?"#hitsMobile":"#hits"
        ...
        searchWrapper[0].addEventListener("mousedown",(e)=>{
           if('/s/v2/tax-experts/' == "/landing-pages/search/"){
               e.preventDefault()
