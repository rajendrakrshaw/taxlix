...
<head>
	<meta charset="UTF-8" />
	<title>
		Financial Services for Individuals in India - ITR Efiling, Mutual Fund Investments, Expert Assisted Services
	</title>
	...
	<meta name="description" content="Efile ITR ( Income Tax Returns  ) for FY 2019-20 (AY 2020-21) online with ClearTax. ClearTax is fast, safe and easy for ITR E-Filing. ClearTax handles all cases of Income from Salary, Interest Income, Capital Gains, House Property, Business and Profession. Maximize your Tax savings and deductions by handling all deductions under Section 80 &amp; the rest. Get compliant, with expert assisted services. Trusted by hundreds of Tax experts and corporations for filing taxes and TDS." />
	...
	<meta name="twitter:title" content="Financial Services for Individuals in India - ITR Efiling, Mutual Fund Investments, Expert Assisted Services" />
	<meta name="twitter:description" content="Efile ITR ( Income Tax Returns  ) for FY 2019-20 (AY 2020-21) online with ClearTax. ClearTax is fast, safe and easy for ITR E-Filing. ClearTax handles all cases of Income from Salary, Interest Income, Capital Gains, House Property, Business and Profession. Maximize your Tax savings and deductions by handling all deductions under Section 80 &amp; the rest. Get compliant, with expert assisted services. Trusted by hundreds of Tax experts and corporations for filing taxes and TDS." />
	...
	<!-- For Canonical Link Addition -->
		...
		<link rel="canonical" href="https://cleartax.in/you">
    ...
    "navbar": {
      ...
      "right": {
        ...
        "item_4": {
          ...
          "designType": "blue_btn",
          "new_tab": true,
          "url": "https://cleartax.in/s/contact-sales?pageCategoryType=einvoice&ref=/s/v2/individuals/",
          "hide_for_logged_in_user": true
        },
        "item_5": {
          "label_text": "My Account",
...
<div class="lil-max-w-screen-xl lil-mx-auto guitar lil-pt-10 sm:lil-pt-20">
	<div
		...
		<div class="lil-w-1/2 md:lil-w-full sm:lil-w-full">
			<p class="lil-text-s-24 lil-font-bold sm:lil-hidden">For Individuals</p>
			<h1 class="lg:lil-text-s-56 hero-header">More <span class="lil-text-blue-350"> money</span><br>in your pocket</h1>
			<div class="lil-flex lil-pt-4 lil-items-center">
				<div class="lil-tick-wrapper">
					<div class="lil-tick"></div>
				</div>
				<p class="lil-px-2 lg:lil-text-s-18 sm:lil-w-5/6 hero-line"><a onclick="handleTrack({label: 'hero_text_link', obj: this})" href="https://cleartax.in/income-tax-efiling" class="lil-underline">File your tax returns</a> in under 3 minutes</p>
			</div>
			<div class="lil-flex lil-pt-4 lil-items-center sm:lil-pt-2">
				<div class="lil-tick-wrapper">
					<div class="lil-tick"></div>
				</div>
				<p class="lil-px-2 lg:lil-text-s-18 sm:lil-w-5/6 hero-line"><a onclick="handleTrack({label: 'hero_text_link', obj: this})" href="https://cleartax.in/save" class="lil-underline">Invest</a> in mutual funds hand picked by experts
				</p>
			</div>
			<div class="lil-flex lil-pt-4 lil-items-center sm:lil-pt-2">
				<div class="lil-tick-wrapper">
				...
				<p class="lil-px-2 lg:lil-text-s-18 sm:lil-w-5/6 hero-line">Now on your phone with <a onclick="handleTrack({label: 'hero_text_link', obj: this})" href="https://cleartax.in/s/black/" class="lil-underline">Black</a></p>
			</div>
			<div class="lil-pt-6 lil-mt-4 lil-flex lil-flex-wrap sm:lil-hidden sm:lil-mt-0 sm:lil-pt-8">
				<a onclick="handleTrack({label: 'hero_button', obj: this})" href="./customerSales.php" class="lil-btn lil-btn-blue sm:lil-w-full">Request a demo</a>
				
			</div>
		</div>
		<div class="lil-w-1/2 md:lil-w-full sm:lil-w-full">
			<img src="https://assets1.cleartax-cdn.com/cleartax/images/1606384910_individual_hero1.png"
				class="lil-block lil-mx-auto xl:lil-ml-8" />
		</div>
	</div>
</div>
<div class="lil-container">
	...
	<section class="lil-mb-6 md:lil-pt-20 sm:lil-mt-20">
		<h2 class="lil-text-center sm:lil-text-left">Loved by over <span class="lil-text-blue-350">6 million</span> tax payers</h2>
		<div class="lil-mt-24 lil-flex lil-justify-around sm:lil-mt-10 sm:lil-flex-wrap sm:lil-items-center">
			<div class="sm:lil-w-1/2 sm:lil-text-center">
				<h3>&#x20B9;200Cr<span class="lil-text-green-250">+</span></h3>
				<p class="lil-text-font-500 sm:lil-pt-2">assets managed</p>
			</div>
			<div class="sm:lil-w-1/2 sm:lil-py-6 sm:lil-text-center">
				<h3>&#x20B9;800Cr<span class="lil-text-green-250">+</span></h3>
				<p class="lil-text-font-500 sm:lil-pt-2">worth taxes filed</p>
			</div>
			<div class="sm:lil-text-center sm:lil-pt-4">
				<h3>35,000<span class="lil-text-green-250">+</span></h3>
				<p class="lil-text-font-500 sm:lil-pt-2">investors</p>
			</div>
		</div>
	</section>
	
	<section class="lil-mt-40 sm:lil-pt-24 sm:lil-mt-0">
		<div class="lil-w-full lil-flex">
			<div class="lil-w-1/2 lil-flex sm:lil-w-full">
				<h2>
					And here's why<br class="md:lil-hidden sm:lil-hidden" /> they trust us
				</h2>
			</div>
			<div class="lil-w-1/2 sm:lil-hidden">
				<img class="lil-float-right lil-w-4/6 sm:lil-float-none"
					src="https://assets1.cleartax-cdn.com/cleartax/images/1606385430_desktop_individual_image_fold1_andhereiswhy_rhs.png" />
			</div>
		</div>
		<div class="lil-w-full lil-flex lil-flex-wrap lil-mt-12 sm:lil-mt-6">
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12"
							src="https://assets1.cleartax-cdn.com/cleartax/images/1606385703_supereasy.svg" />
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
						<h5 class="md:lil-text-s-24 sm:lil-text-s-24">Super Easy</h5>
						<p class="lil-mt-5 sm:lil-mt-4">
							With just your PAN, you can get all your data pre-filled in a few clicks and avoid any manual entries. Get 1000s of capital gains transactions imported in seconds. 
						</p>
					</div>
				</div>
			</div>
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal">
					<div class="lil-promise-icon-wrapper">
						<img class="lil-h-12"
							src="https://assets1.cleartax-cdn.com/cleartax/images/1606385694_maximumsavings.svg" />
					</div>
					<div class="lil-promise-content sm:lil-pt-6">
						<h5 class="md:lil-text-s-24 sm:lil-text-s-24">Maximum tax savings</h5>
						<p class="lil-mt-5 sm:lil-mt-4">
			...
			<div class="lil-w-1/3 sm:lil-w-full">
				<div class="lil-promise-horizontal">
					...
					<div class="lil-promise-content sm:lil-pt-6">
						<h5 class="md:lil-text-s-24 sm:lil-text-s-24">Stress-free</h5>
						<p class="lil-mt-5 sm:lil-mt-4">
...
<!--Section 4-->
<!--Tabs-->
<div class="lil-flex lil-flex-wrap lil-justify-center lil-mt-40 sm:lil-mt-20">
	<div
		class="lil-w-full lil-bg-grey-100 product-segment-tabs lil-sticky lil-flex lil-justify-center lil-border-b-sm lil-border-grey-300">
		<ul id="productSegmentTabs" class="lil-tabs lil-container">
			<li class="lil-tab lil-tab-active lil-w-1/4">
				<a href="#tabReturns">
					<img class="lil-tab-icon"
						src="https://assets1.cleartax-cdn.com/cleartax/images/1606385922_clearreturn.svg" />
					<div class="lil-tab-heading-text lil-flex lil-justify-center lil-items-center">Return filing</div>
				</a>
			</li>
			<li class="lil-tab lil-w-1/4">
				<a href="#tabInvest">
					<img class="lil-tab-icon"
						src="https://assets1.cleartax-cdn.com/cleartax/images/1606385986_clearinvest1.svg" />
					<div class="lil-tab-heading-text lil-flex lil-justify-center lil-items-center">Tax savings</div>
				</a>
			</li>
			<li class="lil-tab lil-w-1/4">
				<a href="#tabServices">
					<img class="lil-tab-icon"
						src="https://assets1.cleartax-cdn.com/cleartax/images/1606385995_clearservices.svg" />
					<div class="lil-tab-heading-text lil-flex lil-justify-center lil-items-center">Expert-assisted plans</div>
				</a>
			</li>
		</ul>
	</div>
	<div id="tabReturns" class="lil-container lil-w-full lil-flex lil-py-48 lil-tab-content sm:lil-py-32">
		<div class="lil-w-1/2 lil-py-24 sm:lil-hidden">
			<img class="xl:lil-hidden lg:lil-hidden md:lil-hidden" src="https://assets1.cleartax-cdn.com/cleartax/images/1606997156_itr_ind.png">
			<video width="100%" height="auto" autoplay muted loop class="sm:lil-hidden">
				<source src="https://assets1.cleartax-cdn.com/cleartax/images/1655199737_filingwalkthrough_video.mp4" type="video/mp4">
				Your browser does not support HTML video.
			</video>
		</div>
		<div class="lil-w-1/2 lil-items-center lil-flex md:lil-w-2/3 sm:lil-w-full">
			<div class="lil-pl-24 sm:lil-pl-0">
				<h4 class="sm:lil-text-s-28">File your ITR in just 3 minutes <br class="lg:lil-hidden md:lil-hidden sm:lil-hidden" />with our DIY plans
				</h4>
				<div class="lil-visible xl:lil-hidden lg:lil-hidden md:lil-hidden">
					<img src="https://assets1.cleartax-cdn.com/cleartax/images/1606997156_itr_ind.png">
				</div>
				<div class="lil-flex lil-pt-10">
					<div class="lil-w-1/6 xl:lil-w-1/12"><img
							src="https://assets1.cleartax-cdn.com/cleartax/images/1604911064_ic_switch_jobs.png"
							height="40" width="40" /></div>
					<div class="lil-px-6 lil-w-5/6">
						<p class="lil-text-font-500 lil-text-base lil-font-bold">100% pre-fill</p>
						<p class="lil-text-base lil-pt-2">Get your data pre-filled entirely with just your PAN</p>
					</div>
				</div>
				<div class="lil-flex lil-pt-8">
					<div class="lil-w-1/6 xl:lil-w-1/12"><img
							src="https://assets1.cleartax-cdn.com/cleartax/images/1604911072_ic_sold_property.png"
							height="40" width="40" /></div>
					<div class="lil-px-6 lil-w-5/6">
						<p class="lil-font-bold lil-text-font-500 lil-text-base">Upload multiple Form 16s</p>
						<p class="lil-text-base lil-pt-2">Simply drag and drop as many Form 16s seamlessly</p>
					</div>
				</div>
				<div class="lil-flex lil-pt-8">
					<div class="lil-w-1/6 xl:lil-w-1/12"><img
							src="https://assets1.cleartax-cdn.com/cleartax/images/1604911080_ic_additional_income.png"
							height="40" width="40" /></div>
					<div class="lil-px-6 lil-w-5/6">
						<p class="lil-font-bold lil-text-base lil-text-font-500">Capital gains transactions </p>
						<p class="lil-text-base lil-pt-2">Import 1000s of capital gains transactions in seconds</p>
					</div>
				</div>
				<div class="lil-flex lil-pt-12">
					<a onclick="handleTrack({label: 'fold_file_your_returns_button', obj: this})" href="./signup.php" class="lil-btn lil-btn-white lil-px-0">File now <span class="lil-font-medium">&nbsp;
							&#8594;</span> </a>
				</div>
			</div>
		</div>
	</div>
	<div id="tabInvest" class="lil-container lil-w-full lil-flex lil-py-48 lil-tab-content sm:lil-py-32">
		<div class="lil-w-1/2 sm:lil-hidden">
			<img class="xl:lil-hidden lg:lil-hidden md:lil-hidden" src="https://assets1.cleartax-cdn.com/cleartax/images/1606387166_diy1.png">
			<video width="100%" height="auto" autoplay muted loop class="lil-block lil-mx-auto sm:lil-hidden">
				<source src="https://assets1.cleartax-cdn.com/cleartax/images/1608284166_individuals_invest.mp4" type="video/mp4">
				Your browser does not support HTML video.
			</video>
		</div>
		<div class="lil-w-1/2 lil-items-center lil-flex md:lil-w-2/3 sm:lil-w-full">
			<div class="lil-pl-24 sm:lil-pl-0 sm:lil-w-full">
				<h4 class="sm:lil-text-s-28">Save up to Rs 46,800, <br class="lg:lil-hidden md:lil-hidden" />invest in expert-curated funds
				</h4>
				<div class="lil-visible xl:lil-hidden lg:lil-hidden md:lil-hidden">
					<img src="https://assets1.cleartax-cdn.com/cleartax/images/1606387166_diy1.png">
				</div>
				<div class="lil-flex lil-pt-10">
					<div class="lil-w-1/6 xl:lil-w-1/12"><img
							src="https://assets1.cleartax-cdn.com/cleartax/images/1604911308_ic_tax_savings.png"
							height="40" width="40" /></div>
					<div class="lil-pl-6 lil-w-full">
						<p class="lil-text-font-500 lil-text-base lil-font-bold">Grow your wealth</p>
						<p class="lil-text-base lil-pt-2">Invest in funds that save AND grow your savings</p>
					</div>
				</div>
				<div class="lil-flex lil-pt-8">
					<div class="lil-w-1/6 xl:lil-w-1/12"><img
							src="https://assets1.cleartax-cdn.com/cleartax/images/1604911317_ic_different_goals.png"
							height="40" width="40" /></div>
					<div class="lil-pl-6 lil-w-full">
						<p class="lil-font-bold lil-text-font-500 lil-text-base">Funds for every goal
						</p>
						<p class="lil-text-base lil-pt-2">Expert-curated A-grade funds to meet your investment horizon</p>
					</div>
				</div>
				<div class="lil-flex lil-pt-8">
					<div class="lil-w-1/6 xl:lil-w-1/12"><img
							src="https://assets1.cleartax-cdn.com/cleartax/images/1604911329_ic_dont_want_locked.png"
							height="40" width="40" /></div>
					<div class="lil-pl-6 lil-w-full">
						<p class="lil-font-bold lil-text-base lil-text-font-500">Flexible lock-in </p>
						<p class="lil-text-base lil-pt-2">For 1 to 5-year duration, pay monthly or one-time</p>
					</div>
				</div>
	...
	<div id="tabServices" class="lil-container lil-w-full lil-flex lil-py-48 sm:lil-py-32 lil-tab-content">
		<div class="lil-w-1/2 lil-py-24 sm:lil-hidden">
			<img src="https://assets1.cleartax-cdn.com/cleartax/images/1604913400_ic_indi_tab3.png">
		</div>
		<div class="lil-w-1/2 lil-items-center lil-flex md:lil-w-2/3 sm:lil-w-full">
			<div class="lil-pl-24 sm:lil-pl-0 sm:lil-w-full">
				<h4 class="sm:lil-text-s-28">Expert-assisted plans to<br class="lg:lil-hidden md:lil-hidden" /> help you file seamlessly 
				
				</h4>
				<div class="lil-visible lil-pt-10 xl:lil-hidden lg:lil-hidden md:lil-hidden">
					<img src="https://assets1.cleartax-cdn.com/cleartax/images/1604913400_ic_indi_tab3.png">
				</div>
				<div class="lil-flex lil-pt-10">
					<div class="lil-w-1/6 xl:lil-w-1/12"><img
							src="https://assets1.cleartax-cdn.com/cleartax/images/1604911578_ic_starting_your_company.png"
							height="40" width="40" /></div>
					<div class="lil-px-6 lil-w-full">
						<p class="lil-text-font-500 lil-text-base lil-font-bold">Starting your own company?</p>
						<p class="lil-text-base lil-pt-2">From company incorporation to GSTIN registration</p>
					</div>
				</div>
				<div class="lil-flex lil-pt-8">
					<div class="lil-w-1/6 xl:lil-w-1/12"><img
							src="https://assets1.cleartax-cdn.com/cleartax/images/1604911586_ic_freelancer.png"
							height="40" width="40" /></div>
					<div class="lil-px-6 lil-w-full">
						<p class="lil-font-bold lil-text-font-500 lil-text-base">Freelancer, trader or foreign income?
						</p>
						<p class="lil-text-base lil-pt-2">Expert assisted tax filing for anything complicated</p>
					</div>
				</div>
				<div class="lil-flex lil-pt-8">
					<div class="lil-w-1/6 xl:lil-w-1/12"><img
							src="https://assets1.cleartax-cdn.com/cleartax/images/1604911595_ic_registration_with_govn.png"
							height="40" width="40" /></div>
					<div class="lil-px-6 lil-w-full">
						<p class="lil-font-bold lil-text-base lil-text-font-500">Registering with governments?</p>
						<p class="lil-text-base lil-pt-2">Trademarks, PF, food licenses, anything</p>
					</div>
				</div>
				<div class="lil-flex lil-pt-12">
					<a onclick="handleTrack({label: 'fold_clear_services_button', obj: this})" href="./services.php" class="lil-btn lil-btn-white lil-px-0">Explore services<span class="lil-font-medium">&nbsp;
							&#8594;</span> </a>
				</div>
			</div>
		</div>
...
<div class="lil-container">
	<!--Section 5-->
	<!--Security-->
	<div class="lil-mt-40 sm:lil-mt-20">
		<!--[ALL IMAGES TO BE UPDATEDS]-->
		<div class="lil-flex lil-justify-between lil-items-center sm:lil-flex-col">
			<div class="lil-pr-16 md:lil-pr-0 sm:lil-w-full sm:lil-pr-0">
				...
				<p class="lil-my-2 lil-text-left lil-pt-6 lil-w-3/5 sm:lil-w-full">
					We take your data very seriously. Right from data transmission to storage,
					we ensure encryption and strictest privacy protocols.
				</p>
			</div>
			<div class="lil-flex lil-justify-end lil-w-1/2 lil-items-center sm:lil-hidden">
				<img class="lil-w-4/5" src="https://assets1.cleartax-cdn.com/cleartax/images/1620036903_security_shield.png">
			</div>
		</div>
		<div class="lil-flex lil-py-32 lil-justify-between md:lil-py-12 sm:lil-py-4 sm:lil-flex-col">
			<div class="lil-w-1/3 sm:lil-w-full">
		...
		<div class="lil-reinforcement-content-wrapper">
			<div class="sm:lil-w-full">
				<div class="lil-reinforcement-title">
					<h3>It’s fast and easy.<br />File your ITR now!<h3>
				</div>
				<div class="lil-reinforcement-button-wrapper lil-py-4">
					<a onclick="handleTrack({label: 'reinforcement_fold_button', obj: this})" href="./signup.php" class="lil-btn lil-btn-blue lil-mr-4 sm:lil-w-full sm:lil-mb-6">File tax returns</a>
					
				</div>
			</div>
			<div class="lil-flex lil-flex-reverse lil-items-start lil-w-1/2 sm:lil-w-full sm:lil-h-64">
				<img class="sm:lil-object-scale-down sm:lil-h-full" src="https://assets1.cleartax-cdn.com/cleartax/images/1606386811_desktop_individual_image_fold_itseasytogetstarted_rhs.png">
			</div>
		</div>
	</div>
</div>
...
<script>
	(function(){
		new CustomTab('productSegmentTabs', {
			scrollableTab: true,
		})
	})();
</script>
...
<script>
	(function() {
      ...
      document.getElementById("dynamicDownloadBtn").children[1].setAttribute("href", "https://play.google.com/store/apps/details?id=in.cleartax.consumer2&referrer=utm_source%3Dwebsite%26utm_medium%3Ditr-page-link%26utm_campaign%3Ditr-page");
      document.getElementById("dynamicDownloadBtn").children[0].setAttribute("src", "https://assets1.cleartax-cdn.com/cleartax/images/1606245443_playstore_white.svg");
		}
        else if((navigator.userAgent.toLowerCase().indexOf('iphone')>-1)||(navigator.userAgent.toLowerCase().indexOf('ipad')>-1)||(navigator.userAgent.toLowerCase().indexOf('mac')>-1)){
					document.getElementById("dynamicDownloadBtn").children[0].setAttribute("src", "http://cleartax-media.s3.amazonaws.com/cleartax/images/1630482990_appstore_icon.svg");
					document.getElementById("dynamicDownloadBtn").children[1].setAttribute("href", "https://apps.apple.com/in/app/black-mutual-funds-sip/id1559408178");
...
const handleTrackGA4 = (action, logObj, trackValueObj) => {
    ...
    if (window.ga) {
        ...
        gtag('set', 'content_group', 'v2_individuals');
...
<!-- Page scheme -->
	...
	<script type="application/ld+json">
	{
		...
		"mainEntityOfPage": {
			"@type": "WebPage",
			"@id": "https://cleartax.in/you"
			
		},
		"headline": "Financial Services for Individuals in India - ITR Efiling, Mutual Fund Investments, Expert Assisted Services",
		"description": "Efile ITR ( Income Tax Returns  ) for FY 2019-20 (AY 2020-21) online with ClearTax. ClearTax is fast, safe and easy for ITR E-Filing. ClearTax handles all cases of Income from Salary, Interest Income, Capital Gains, House Property, Business and Profession. Maximize your Tax savings and deductions by handling all deductions under Section 80 &amp; the rest. Get compliant, with expert assisted services. Trusted by hundreds of Tax experts and corporations for filing taxes and TDS.",
		"image": {
			"@type": "ImageObject",
    ...
    window.addEventListener('DOMContentLoaded', () => {
       ...
       const hitsBoxId = isSearchMobile?"#hitsMobile":"#hits"
        ...
        searchWrapper[0].addEventListener("mousedown",(e)=>{
           if('/s/v2/individuals/' == "/landing-pages/search/"){
               e.preventDefault()
